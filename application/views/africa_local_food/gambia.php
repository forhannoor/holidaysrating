...
<meta name="description" content="Local Food Gambia"/>
<meta name="keywords" content="Food, What to eat in Gambia, Travel to Gambia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Gambia</title>
...
• Benachin (also called 'Jollof Rice', a mixture of spiced meat and rice with tomato puree and vegetables). <br>
• Domodah (meat stewed in groundnut puree and served with rice). <br>
• Chicken yassa (chicken cooked with onions, garlic and lime, served with rice or chips). <br>
• Plasas (meat and smoked fish cooked in palm oil with cassava leaves, served with rice or mashed cassava). <br>
• Mafe (meat stew simmered in sauce thickened with ground peanuts). <br>
• Haako (steamed couscous served with a vegetable sauce).	</p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/gambia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/gambia', 'Gambia') ?>&gt; Local Food</span></p>
