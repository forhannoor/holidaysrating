...
<meta name="description" content="Local Food São Tomé and Príncipe"/>
<meta name="keywords" content="Food, What to eat in São Tomé and Príncipe, Travel to São Tomé and Príncipe, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | São Tomé and Príncipe</title>
...
<div class="edit1"><p> Popular food menu: <br><br>
• Grilled fish and chicken. <br>
• Fried fish. <br>
• Cooked bananas. <br>
• Buzios (large land snails). <br>
• Tropical fruit. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sao_tome_and_principe_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sao_tome_and_principe', 'São Tomé and Príncipe') ?>&gt; Local Food</span></p>
