...
<meta name="keywords" content="Food, What to eat in Liberia, Travel to Liberia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Liberia</title>
...
<div class="edit1">
<p>  
• Palm nuts with shrimp in fish or chicken stock. <br>
• Rice bread made with mashed bananas. <br>
• Goat soup is a national menu. <br>
• Cabbage cooked with bacon and pigs' feet. </p>  
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/liberia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/liberia', 'Liberia') ?>&gt; Local Food</span></p>
