...
<meta name="description" content="Local Food Côte d'Ivoire"/>
<meta name="keywords" content="Food Cote d'Ivoire, What to eat in Cote d'Ivoire, Travel to Côte d'Ivoire, Local Food, Ivorycoast, Recipes"/>
...
<div class="edit1"><p>   <strong> Traditional food menu: <br> <br>
• Kedjenou (chicken cooked with different vegetables). <br>
• N'voufou (mashed bananas or yam mixed with palm oil and other things). <br>
• Attieké (cassava dish). <br> <br>

National drinks: <br>
• Bangui (local palm wine). </strong> </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cote_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/cote_d_ivoire', 'Côte d Ivoire') ?>&gt; Local Food</span></p>
