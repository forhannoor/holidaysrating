...
<meta name="description" content="Local Food Malawi"/>
<meta name="keywords" content="Food, What to eat in Malawi, Travel to Malawi, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Malawi</title>
...
• White maize eaten with vegetables and sometimes meat or fish.<br>
• Nthochi (bread made with banana).<br>
• Mbatata cookies (made with sweet potato and cinnamon).<br>
• Fresh fish from Lake Malawi is the country's speciality, chambo (Tilapia fish) being the main lake delicacy.<br>
• There are trout from streams on the Zomba, Mulanje and Nyika plateaus.<br>
</p>  </div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/malawi_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/malawi', 'Malawi') ?>&gt; Local Food</span></p>
