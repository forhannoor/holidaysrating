...
<meta name="keywords" content="Food, What to eat in Burundi, Travel to Burundi, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Burundi</title>
...
<div class="edit1"><p>  Burundi may not be so rich in food and taste. The foods you see there are boiled and roasted over wood fire. Meals in Bujumbura's hotels are cheap. The French, Greek and Asian restaurants in the town are good. <BR><BR>
Specialities: <BR><BR>
• Staple ingredients include plantains, sweet potatoes, cassava, peas and maize. 
• Common snacks are fruit, cane sugar and groundnuts. 
• Spicy carrots might be good. <BR><BR>
Regional drinks: <BR><BR>
Urwarwa is a home-based banana wine drunk during celebrations. 
Primus beer is produced in Burundi, as is impeke, a home-brewed beer made from sorghum, and often drunk through straws. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/burundi_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/burundi', 'Burundi') ?>&gt; Local Food</span></p>
