...
<meta name="description" content="Local Food Egypt"/>
<meta name="keywords" content="Food, What to eat in Egypt, Travel to Egypt, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Egypt</title>
...
<div class="edit1"><p>  Travelers should not miss the following menu: <br><br>
• Ful medames (fava beans topped with eggs) <br>
• Babaganoush (pureed aubergines) <br>
• Fuul (fava beans with lemon and herbs) <br>
• Stuffed vine leaves. <br>
• Temayya (falafel). <br>
• Kebabs (meat on skewers). <br>
• Koshari (rice, lentil, pasta and tomato dish). <br>
• Mahallabiyaa (rice desert) <br>
<br><br>
Drinks: <br><br>
• Kahwa (thick, strong coffee). <br>
• Shay bil na'na' (mint tea). <br>
• Karkaday (clear, bright red drink made from hibiscus flowers). <br>
• Aswanli (dark beer made in Aswan). <br>
• Zibib (alcoholic aniseed-flavoured drink). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/egypt_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/egypt', 'Egypt') ?>&gt; Local Food</span></p>
