...
<meta name="description" content="Local Food Ghana"/>
<meta name="keywords" content="Food, What to eat in Ghana, Travel to Ghana, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Ghana</title>
...
<div class="edit1"><p>  • Kenkey (a firm ball of fermented maize boiled in a removable wrapping of plantain leaves and served with a spicy tomato sauce or hot peppers and fried tilapia). <br>
• Akyeke (cassava couscous served with avocado). <br>
• Fufu (a sticky ball of pounded cassava beans, yam, plantain or rice, usually accompanying traditional stews such as palm nut, ground nut, kontomere or okro). <br>
• Fante fante (a palm oil stew with small fish, popular in the central regions). <br>
• Akrantee (bushmeat). <br>
• Red red (the favourite local dish of many visitors is this spicy concoction of rice and beans cooked in red palm oil). <br>
• Kalawole (deep-fried plantain cubes seasoned with ginger, pepper and salt). <br>
• Palava (spicy sauce made from spinach-like cocoyam leaves). <br>
• Jollof rice (a spicy rice dish made with red palm oil, often cooked together with chicken, fish, or meat in the dish). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/ghana_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/ghana', 'Ghana') ?>&gt; Local Food</span></p>
