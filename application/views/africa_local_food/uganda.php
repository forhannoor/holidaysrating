...
<meta name="description" content="Local Food Uganda"/>
<meta name="keywords" content="Food, What to eat in Uganda, Travel to Uganda, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Uganda</title>
...
<div class="edit1">
<p>  
• Cassava (a starchy root, commonly made into flour). <br>
• Chapati (Indian-style flat bread fried in oil). <br>
• Grasshoppers (the crunchy, deep-fried insects are a popular street food). <br>
• Luwombo (stew made from meat, vegetables or fish steamed in banana leaves). <br>
• Matoke (a green banana, often steamed in its own leaves and mashed). <br>
• Millet bread (a mixture of millet and cassava flour, eaten with peanut or meat sauce). <br>
• Posho (made from white cornflower, this starchy staple is similar to polenta). <br>
• Samosa (deep-fried savoury pastries filled with vegetables and sometimes meat). <br>
• White ants (a popular fried insect snack). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/uganda_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/uganda', 'Uganda') ?>&gt; Local Food</span></p>
