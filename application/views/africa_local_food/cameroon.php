...
<meta name="description" content="Local Food Cameroon"/>
<meta name="keywords" content="Food, What to eat in Cameroon, Travel to Cameroon, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Cameroon</title>
...
<div class="edit1"><p>  
Special items:<br>
• Zom (spinach with meat). <br>
• Fried sweet potatoes or plantains. <br>
• Feuille (manioc leaves). <br>
• West African peanut soup. <br>
• Banana bread. <br>

• Beef with pineapple or coconut. <br><br>

drinks: <br>
•Bil-bil (a homemade beer made from millet, sorghum or corn). <br>
•Palm wine. <br>
• Afofo (a firewater distilled from palm sap). <br>
• Coffee. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cameroon_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/cameroon', 'Cameroon') ?>&gt; Local Food</span></p>
