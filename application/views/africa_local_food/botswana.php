...
<meta name="keywords" content="Food, What to eat in Botswana, Travel to Botswana, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Botswana</title>
...
<div class="edit1"><p>  Good restaurants and bars are seen in main towns, often within hotels. Goat, beef and chicken are very popular meats. But in the countryside food is so ordinary. <BR><BR>
<strong> Specialties: </strong> <br>
• Morogo <br>
• Morama <br>
• The Kalahari truffle. <br>
• Mopane worms <br>
• Beans such as cow peas, ditloo (jugo beans) and letlhodi (china beans), dried bean leaves, plus nuts like peanuts and groundnuts. <BR><BR>

<strong> Local drinks:  </strong> <BR>
Very strong palm wine <br>
Traditional beer <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/botswana_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/botswana', 'Botswana') ?>&gt; Local Food</span></p>
