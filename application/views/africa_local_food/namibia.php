...
<meta name="description" content="Local Food Namibia"/>
<meta name="keywords" content="Food, What to eat in Namibia, Travel to Namibia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Namibia</title>
...
<div class="edit1"><p>  
• Biltong (an air-dried meat, which is a bar snack staple, usually made from beef or kudu). <br>
• Rauchfleisch (smoked meat). <br>
• Game such as antelope, ostrich or zebra cooked on a braai (barbecue). <br>
• Potjiekos (one-pot bush stew, usually cooked over a camp fire, and made with just about anything although chicken and vegetable is common). <br>
• Seafood, especially oysters, on the coast. <br>
• Kalahari truffles (a distant cousin of the European black and white truffle varieties found on Swakopmund restaurant menus, served up thinly sliced and drizzled with olive oil alongside a thick ostrich steak.) <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/namibia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/namibia', 'Namibia') ?>&gt; Local Food</span></p>
