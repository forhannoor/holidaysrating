...
<meta name="description" content="Local Food Sierra Leone"/>
<meta name="keywords" content="Food, What to eat in Sierra Leone, Travel to Sierra Leone, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Sierra Leone</title>
...
• Cassava bread <br>
• Okra stew <br>
• Cassava and potato leaf stews<br> 
• Krin krin and fish balls <br>
• Yebe <br>
• Grilled meat and fish<br> 
• Benny cake <br>
• Coconut cake <br>
• Plantain chips<br>
• Groundnut <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sierra_leone_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sierra_leone', 'Sierra Leone') ?>&gt; Local Food</span></p>
