...
<meta name="description" content="Local Food Angola"/>
<meta name="keywords" content="Food, What to eat in Angola, Travel to Angola, Local food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Angola</title>
...
<div class="edit1">
<p>Many tourists prefer eating and drinking in the hotel only as many of the less well equipped restaurants have poor hygienic conditions. However, Angolan cuisine is varied and tasty, with local dishes based mostly on fish, cassava items and spicy stews. Angolan seafood is plentiful and very good, and the Angolan coast is a special place to eat fresh lobster right off the fisherman's boat. It should also be mentioned that restaurants in Luanda are increasing in numbers and superiority, as the current political situation is calm and has brought stability and significant investment to the country.<br>
Usually, all restaurants accept US dollars in cash. And credit cards will not be accepted. </p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/angola_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/angola', 'Angola') ?>&gt; Local Food</span></p>
