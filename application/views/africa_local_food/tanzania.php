...
<meta name="description" content="Local Food Tanzania"/>
<meta name="keywords" content="Food, What to eat in Tazania, Travel to Tanzania, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Tanzania</title>
...
<div class="edit1"><p>  
• Nyama choma (barbecued meat). <br>
• Ugali (maize meal porridge). <br>
• Mandazi (doughnuts). <br>
• Kachumbari (spicy tomato relish served with meat). <br>
• Wali wa nazi (rice cooked with coconut milk). <br>
• Mchuzi wa kamba (prawn curry with tomatoes). <br>
• Matoke (boiled and mashed plantain). <br>
• Mishkaki (beef kebabs). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/tanzania_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/tanzania', 'Tanzania') ?>&gt; Local Food</span></p>
