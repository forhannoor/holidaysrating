...
<meta name="description" content="Local Food Democratic Republic of Congo"/>
<meta name="keywords" content="Food, What to eat in Democratic Republic of Congo, Travel to Democratic Republic of Congo, DRC, D.R.C., Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Guinea</title>
...
<div class="edit1"><p>  
• Fish (giant oysters and shrimps). <br> <br>
• Piri piri chicken (with chilli pepper). <br> <br>
• Mouamba (chicken in palm oil). <br> <br>
• Saka saka (ground cassava leaves cooked with palm oil and peanut paste). <br> <br>
• Maboke (freshwater fish cooked in large marantacee leaves). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/drc_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/democratic_republic_of_congo', 'Democratic Republic of Congo') ?>&gt; Local Food</span></p>
