...
<meta name="description" content="Local Food Zambia"/>
<meta name="keywords" content="Food, What to eat in Zambia, Travel to Zambia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Zambia</title>
...
• Nshima (stiff porridge made from ground maize). The traditional Zambian staple is eaten daily in the rural areas. A thinned down version may be eaten for breakfast with sugar. 
• Ndiwo, sometimes called relish (sauce made from meat or fish boiled with green vegetables, usually served with nshima). 
• Ifisashi (vegetarian stew of peanuts, tomatoes, spinach and cabbage).Used to accompany nshima, especially among the Bemba people of northern Zambia. 
• Samp (starchy dish made from crushed beans). 
• Kibbutz salad (chopped cucumber, tomatoes, garlic and parsley). 
• Biltong (spicy meat, preserved by drying it until it’s chewy). 
• Sautéed insects such as grasshoppers, caterpillars, cicadas and flying ants are seasonal delicacies for rural Zambians. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/zambia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/zambia', 'Zambia') ?>&gt; Local Food</span></p>
