...
<meta name="description" content="Local Food Eritrea"/>
<meta name="keywords" content="Food, What to eat in Eritrea, Travel to Eritrea, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Eritrea</title>
...
<div class="edit1"><p>  
• Capretto (goat, usually served like a rack of lamb). <br>
• Frittata (scrambled eggs with onion and peppers). <br>
• Nai tsom (fasting food - vegetarian combination). <br>
• Ful (stewed beans with onion and tomato, normally eaten for breakfast or dinner). <br>
• Kitcha fitfit (pieces of kitcha served with yogurt and butter). <br>
• Shiro (chick pea purée). <br>
• Ades (lentils). <br>
• Kitcha (a thin bread made from wheat). <br>
• Injera (a spongy pancake). <br>
• Tsebhi (meat sauté of either lamb or beef with fresh tomatoes and hot peppers). <br>
• Alicha birsen (lentil curry). <br>
• Zigini (meat stew). <br>
• Zigna assa (fish stew). <br>
• Tibzi (meat sauté of either lamb or beef with fresh tomatoes and hot peppers). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/eritrea_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/eritrea', 'Eritrea') ?>&gt; Local Food</span></p>
