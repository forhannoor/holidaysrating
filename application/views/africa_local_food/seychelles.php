...
<meta name="description" content="Local Food Seychelles"/>
<meta name="keywords" content="Food, What to eat in Seychelles, Travel to Seychelles, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Seychelles</title>
...
<div class="edit1"><p>  
• Grilled fish with chatini Seychellois (crushed chillies, ginger, garlic). <br>
• Tamarind chutney. <br>
• Shredded green papaya salad. <br>
• Breadfruit (a fruit native to South East Asia, often a replacement to rice) and heart of palm (the inner core of certain palm trees). <br>
• Carotte bananas (bananas wrapped in banana leaves with honey and vanilla). <br>
• Kat-kat banana (banana cooked in coconut milk). <br>
• Coconut fish curry. <br>
• Chatini requin (shark chutney). <br>
• Soupe de tectec (clam cooked in tomatoes, garlic and ginger). <br>
• Bouillon bréde (spinach broth). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/seychelles_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/seychelles', 'Seychelles') ?>&gt; Local Food</span></p>
