...
<meta name="description" content="Local Food Kenya"/>
<meta name="keywords" content="Food, What to eat in Kenya, Travel to Kenya, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Kenya</title>
...
<div class="edit1"><p>  Traditional Foods<br><br>
• Ugali (maize meal porridge). <br>
• Mandazi (doughnuts). <br>
• Kachumbari (spicy tomato relish served with meat). <br>
• Game park lodges serve game, which may be marinated in local liqueurs and berries. <br>
• Nyama choma (barbecued meat served with a spicy tomato relish). <br><br>

Drinks: <br><br>
•	Tusker and White Cap (locally brewed beer). <br>
•	Kenya Cane (spirit distilled from sugar cane). <br>
•	Kenya Gold (a coffee liqueur). <br>
•	Uki (traditional beer made with honey). <br>
•	Changaa (locally made spirit distilled from maize). <br>
•	Chai (tea boiled with milk and sugar) </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/kenya_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/kenya', 'Kenya') ?>&gt; Local Food</span></p>
