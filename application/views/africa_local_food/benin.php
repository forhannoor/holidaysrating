...
<meta name="description" content="Local Food Benin"/>
<meta name="keywords" content="Food Benin, What to eat in Travel to Benin, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Benin</title>
...
<div class="edit1"><p>  In the southern part of Benin, you will see tasty seafood like prawns, crabs and lobsters. Millet couscous is popular in the north zone of Benin. Restaurants have seafood menus with the occasional French ones on special times. The great local dish is the stew made of shellfish, tomatoes, onion and the hot sauce called ‘pilipili’. Foods in Benin are imperfect without sauce – a favourite is the ‘lamounou dessi’ made with fish, smoked shrimp, vegetables and chillies. The usual Beninese meal would have any of these staples - yams, beans, cassava, corn, millet and rice. </p></div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/benin_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/benin', 'Benin') ?>&gt; Local Food</span></p>
