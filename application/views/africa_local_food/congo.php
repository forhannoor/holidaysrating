...
<meta name="description" content="Local Food Congo"/>
<meta name="keywords" content="Food, What to eat in Congo, Travel to Congo, Local Food, Recipes"/>
...
<div class="edit1"><p>  Traditional food: <br><br>
• Moambe chicken with rice and spinach. <br>
• Fried yams. <br>
• Corn and beans. <br><br>
Regional drinks: <br><br>
• Paupau paradise. <br>
• Pineapple bugada. <br>
• White elephant (coconut, rum and milk). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/congo_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/congo', 'Congo') ?>&gt; Local Food</span></p>
