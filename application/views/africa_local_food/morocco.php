...
<meta name="description" content="Local Food Morocco"/>
<meta name="keywords" content="Food, What to eat in Morocco, Travel to Morocco, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Morocco</title>
...
<div class="edit1"><p>  
• Harira (a spicy tomato-and-lentil-based soup). <br>
• Pastilla (a pigeon-meat pie layered with flaky dough and dusted with cinnamon and sugar). <br>
• Couscous (a savoury semolina dish cooked with local vegetables and/or meat). <br>
• Tajine (a rich, fragrant stew, with some combination of lamb, chicken or fish with onions, olives, almonds, tomato, herbs or dried fruit). <br>
• Mechoui (slow-roasted stuffed lamb or beef). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/morocco_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/morocco', 'Morocco') ?>&gt; Local Food</span></p>
