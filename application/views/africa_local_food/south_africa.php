...
<meta name="description" content="Local Food South Africa"/>
<meta name="keywords" content="Food, What to eat in South Africa, Travel to South Africa, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | South Africa</title>
...
<div class="edit1">
<p>  • Boerworst (a fairly spicy high-quality sausage, essential for a braai). <br>
• Bobotie (a curried mince stew often studded with raisins). <br>
• Potjiekos (a spicy casserole cooked in an iron pot). <br>
• Bredie (meat, tomato and vegetable casserole). <br>
• Biltong (dried meat, typically beef or venison). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/south_africa_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/south_africa', 'South Africa') ?>&gt; Local Food</span></p>
