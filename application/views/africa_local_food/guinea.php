...
<meta name="description" content="Local Food Guinea"/>
<meta name="keywords" content="Food, What to eat in Guinea, Travel to Guinea, Local Food, Recipes"/>
...
<p>  
• Jollof rice. <br>
• Stuffed chicken with groundnuts. <br>
• Fish (served with rice). <br>
• Cassava, yams and maize. <br>
• Maize soup.
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/guinea_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/guinea', 'Guinea') ?>&gt; Local Food</span></p>
