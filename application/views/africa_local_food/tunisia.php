...
<meta name="description" content="Local Food Tunisia"/>
<meta name="keywords" content="Food, What to eat in Tunisia, Travel to Tunisia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Tunisia</title>
...
<div class="edit1"><p>  
• Couscous (ground semolina served with meat, fish or vegetable sauce). <br>
• Harissa (chilli paste). <br>
• Salade Mechouia (roasted vegetable salad). <br>
• Tajine (a kind of spiced quiche, served cold – no relation to the Moroccan dish of the same name). <br>
• Brik (the Tunisian version of the Turkish borek; a deep-fried filled pastry. Common ingredients include tuna, egg, onions, capers and parsley). <br>
• Merguez (a heavily spiced beef sausage). <br>
• Filfil mahshi (peppers stuffed with beef and harissa). <br>
• Lablabi (a chickpea soup with lashings of garlic). <br>
• Marqa (a slow-cooked stew of meat and vegetables). <br>
• Ojja (Tunisian scrambled eggs, usually spiced with lashings of harissa, as well as tomatoes, peppers and sometimes meat). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/tunisia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/tunisia', 'Tunisia') ?>&gt; Local Food</span></p>
