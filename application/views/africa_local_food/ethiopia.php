...
<meta name="description" content="Local Food Ethiopia"/>
<meta name="keywords" content="Food, What to eat in Ethiopia, Travel to Ethiopia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Ethiopia</title>
...
<div class="edit1"><p>  
• Kai wat (very spicy beef, goat or lamb stew). <br>
• Kitfo (raw or very rare ground beef marinated in a very hot chilli powder). <br>
• Messer (lentil curry). <br>
• Shiro (chickpea puree) <br>
• Tere sega (raw meat, considered a delicacy) <br>
• Tibs (pan-fried lamb cooked with garlic, butter and vegetables) <br>
• Asa wat (fish stew). <br>
• Doro wat (chicken stew). <br>
• Dulet (breakfast dish of pan-fried minced tripe, liver, beef, and chilli). <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/ethiopia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/ethiopia', 'Ethiopia') ?>&gt; Local Food</span></p>
