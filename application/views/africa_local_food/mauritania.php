...
<meta name="description" content="Local Food Mauritania"/>
<meta name="keywords" content="Food, What to eat in Mauritania, Travel to Mauritania, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Mauritania</title>
...
<div class="edit1"><p>  Popular Food:  <br><br>
• Mechoui <br>
• Sweet Dates. <br>
• Spiced fish <br>
• Fish balls, dried fish, dried meat and couscous. <br><br>
 Drinks: <br><br>
Zrig (camel's milk) is a common drink. <br>
Sweet Arab tea with mint. <br><br>

Note: Alcohol is strictly prohibited in the country because of Islamic law. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mauritania_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mauritania', 'Mauritania') ?>&gt; Local Food</span></p>
