        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/papua-new-guinea/asaro-mud men.jpg" title="Papua New Guinea"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Papua New Guinea</h1>
                            	Explore the many amazing things thid island has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/papua-new-guinea/landscape.jpg" title="Papua New Guinea"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Papua New Guinea in Oceania</h1>
                                Papua New Guinea, are a amazing island in Oceania.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/papua-new-guinea/papua.jpg" title="Papua New Guinea"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Papua New Guinea</h1>
                                Have you travel here? Let us know what you think of this island, upload your story.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/papua-new-guinea/papua-tribe.jpg" title="Papua New Guinea"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Papua New Guinea is a magical place!</h1>
                                Add it to your holiday list! Holidaysrating recommand Papua New Guinea!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
