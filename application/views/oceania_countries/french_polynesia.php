...
<meta name="description" content="French Polynesia"/>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/french-polynesia/nonosina-otea-ori.jpg" title="Nonosina Otea Ori"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to French Polynesia, Oceania</h1>
                            	Explore the many amazing things French Polynesia has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/french-polynesia/huahine.jpg" title="Huahine"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">French Polynesia</h1>
                                French Polynesia is a amazing and magical place. Hundreds of Islands.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/french-polynesia/gambier-islands.jpg" title="Gambier Islands"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Is the French Polynesia your next travel destination?</h1>
                                Have you been in French Polynesia, tell us your story!</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/oceania/french-polynesia/bora-bora.jpg" title="Bora Bora"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>French Polynesia in Oceania</h1>
                                Stunning isn't it? Visit Bora Bora, Tahiti or the Gambier Islands.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
