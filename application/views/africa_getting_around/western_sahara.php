...
<meta name="description" content="Getting around in Western Sahara"/>
<meta name="keywords" content="Getting around in Western Sahara, Travel in Western Sahara, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Western Sahara</title>
...
The only international airport is in El Aaiun, the capital. Flights come from the Canary Islands, Morocco, and Spain. Other airports are located in Dakhla and Smara.<br><br>

By train<br>

There are currently no regular trains from El Aaiún from Marrakech, however a line is planned. There is no train service between Agadir and Al Ayun.<br><br>

By car<br>

To arrive by car, one must either pass through Moroccan-controlled checkpoints along the border or enter into the Free Zone through Mauritania. The latter has virtually no roads, so driving will be possible only with a sport-utility vehicle.<br><br>

By bus<br>

Buses are present only in large metropolitan districts</p>  </div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/western_sahara_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/western_sahara', 'Western Sahara') ?>&gt; Getting around</span></p>
