...
<meta name="description" content="Getting around in Lesotho"/>
<meta name="keywords" content="Getting around in Lesotho, Travel in Lesotho, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Lesotho</title>
...
<div class="edit1"><p>  Side of road: <br>
Left <br> <br>

Car hire: <br>
there are some tax issues. Cars can be hired in Maseru. Travelers should know that some border posts can only be reached by four wheel drive. <br> <br>
Taxi and Bus: <br>
Buses and minibus taxis are good for short hops. Buses leave once the bus is full. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/lesotho_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/lesotho', 'Lesotho') ?>&gt; Getting around</span></p>
