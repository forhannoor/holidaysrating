...
<meta name="description" content="Getting around in Mali"/>
<meta name="keywords" content="Getting around in Mali, Travel in Mali, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Mali</title>
...
Travelers should use the main roads, or else they should travel in convoy. Carefulness is so important when travelling at night. Visitors should consult official travel guidance. <br><br>
Side of road: <br>
Right <br><br>
Documentation: <br>
International Driving Permit recommended. <br><br>
Rail: <br>
The train operator is Transrail. A Damar-Bamako train operates randomly because of ongoing engineering works needed immediately on the tracks. <br><br>
By water: <br>
Between July and December, there are notable services between Bamako and Gao via Timbuktu along the River Niger. Though, due to drought in the Sahel desert, services are greatly hampered. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mali_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mali', 'Mali') ?>&gt; Getting around</span></p>
