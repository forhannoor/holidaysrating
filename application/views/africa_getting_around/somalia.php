...
The void left by the collapse of Somali Airlines has largely been filled by Jubba Airlines (JUB) and Daallo Airways. <br><br>
Road: <br>
It is difficult to travel outside Mogadishu by car. <br><br>

Side of road: <br>
Right <br><br>

Car hire: <br>
Available in Mogadishu. <br><br>
Taxi: <br>
These are available in large towns. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/somalia_around', 'Leave a comment') ?>
</div>
