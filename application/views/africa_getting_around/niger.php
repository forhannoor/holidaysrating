...
<meta name="description" content="Getting around in Niger"/>
<meta name="keywords" content="Getting around in Niger, Travel in Niger, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Niger</title>
...
At the time of writing, Niger did not have a national airline or any scheduled domestic services. Charter flights can be arranged; contact Niamey Airport (tel: 732 517/9). <br><br>
Car hire: <br>
Self-drive and chauffeur-driven cars are available, the latter being compulsory outside the capital. Much of the country requires 4-wheel drive vehicles, guides and full equipment. <br><br>
Taxi: <br>
Bush taxis: These are shared intercity taxis and are usually cheaper, but slower, than buses. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/niger_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/niger', 'Niger') ?>&gt; Getting around</span></p>
