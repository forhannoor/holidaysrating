...
<meta name="description" content="Getting around in Malawi"/>
<meta name="keywords" content="Getting around in Malawi, Travel in Malawi, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Malawi</title>
...
Domestic flights are served by charter airline Ulendo Airlink which provides flights to destinations like Lilongwe, Chelinda and Likoma Island. <br><br>
Side of road: <br>
Left <br><br>
Car hire: <br>
This is available, with a number of companies providing a wide choice of vehicles. <br><br>
Bus: There are services in all major cities. <br>
Taxi: These are in short supply and cannot be hailed on the street. Taxi drivers expect a tip. <br><br>
Rail: <br>
Central East African Railways runs the lines in the country. <br><br>
By water: <br>
Cruises on Lake Malawi are available by local steamer. Food and cabins are available. For details contact local travel bureaux. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/malawi_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/malawi', 'Malawi') ?>&gt; Getting around</span></p>
