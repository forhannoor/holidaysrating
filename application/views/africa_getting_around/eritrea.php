...
<meta name="description" content="Getting around in Eritrea"/>
<meta name="keywords" content="Getting around in Eritrea, Travel in Eritrea, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Eritrea</title>
...
Eritrea does not really have good air services at present.  <br><br>
Road: <br>
This country is very safe but it required travel permit from the international tourists. <br><br>
Side of road: <br>
Right <br><br>
Road quality: <br>
The main roads are generally in very superior condition <br><br>
Car hire: <br>
There are a number of local car companies. <br><br>
Taxi: <br>
Taxis are unmetered and can be found in the major towns and cities and at Asmara airport. <br><br>
Bike: <br>
Though Eritreans adore bicycle racing, there are no hire bikes in Eritrea. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/eritrea_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/eritrea', 'Eritrea') ?>&gt; Getting around</span></p>
