...
<meta name="description" content="Getting around in Gambia"/>
<meta name="keywords" content="Getting around in Gambia, Travel in Gambia, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Gambia</title>
...
<div class="edit1">
<p>  Road: <br><br>
Driving is often hard and time-consuming. The conditions of the Roads are very poor, rough with tired tarmac. Cars often have to weave at a snail's pace, or drive adjacent to the road on a mud rack. <br><br>
Car hire: <br><br>
Cars can be hired. Normally the hotels operate car services for the travelers. But driving is not easy because of the road condition. <br><br>

Taxi: <br><br>
Bush taxis are found but they are quite expensive. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/gambia_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/gambia', 'Gambia') ?>&gt; Getting around</span></p>
