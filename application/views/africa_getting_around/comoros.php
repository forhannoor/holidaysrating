...
<meta name="description" content="Getting around in Comoros"/>
<meta name="keywords" content="Getting around in Comoros, Travel in Comoros, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Comoros</title>
...
there are good services between the islands in the region. <BR><BR>
Side of road: <BR><BR>
Right <BR><BR>

Car Rent: <BR><BR>
Services are available on Ngazidja (Grande Comore). <BR><BR>
Taxi: <BR><BR>
Bush taxis (taxis-brousses), hired vehicles or private cars are the only forms of transport on the islands. <BR><BR>
Documentation: <BR><BR>
Documentation: An International Driving Permit is valid for up to three months. <BR><BR>
By water: <BR><BR>
The islands are linked by normal ferry services. motorboats, sailing craft and canoes in port villages and towns are available for hire. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/comoros_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/comoros', 'Comoros') ?>&gt; Getting around</span></p>
