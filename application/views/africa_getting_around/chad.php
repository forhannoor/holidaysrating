...
<meta name="description" content="Getting around in Chad"/>
<meta name="keywords" content="Getting around in Chad, Travel in Chad, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Chad</title>
...
Air Tchad is suspended because it failed to meet international safety standards. <br><br>
Side of road: <br>
Right <br><br>

Petrol is not cheap and petrol stations are not commonly available. <br><br>

most of the roads are bad and broken due to rainy seasons. <br><br>
Documentation: International Driving Permit required for car hire (which is expensive) as well as an official autorisation de circuler. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/chad_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/chad', 'Chad') ?>&gt; Getting around</span></p>
