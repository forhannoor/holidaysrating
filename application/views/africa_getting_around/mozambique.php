...
<meta name="description" content="Getting around in Mozambique"/>
<meta name="keywords" content="Getting around in Mozambique, Travel in Mozambique, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Mozambique</title>
...
LAM-Linhas Aéreas de Moçambique (TM) and Air Corridor offer domestic flights linking Maputo with Beira, Chimoio, Inhambane, Lichinga, Nampula, Pemba, Quelimane and Tete. <br><br>
Car hire: <br>
Cars can be hired from international and local agencies in Maputo and Beira. Only hard currency is accepted. <br><br>
Taxi: <br>
Taxi: Rarely available outside large towns. <br><br>
Coach: <br>
Bus services in Maputo have been improved with the introduction of new vehicles, and there are now fairly extensive services. Taxis are metered and drivers expect a tip. <br><br>
Rail: <br>
There is no rail connection between Maputo and Beira. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mozambique_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mozambique', 'Mozambique') ?>&gt; Getting around</span></p>
