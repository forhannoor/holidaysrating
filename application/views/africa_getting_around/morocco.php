...
<meta name="description" content="Getting around in Morocco"/>
<meta name="keywords" content="Getting around in Morocco, Travel in Morocco, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Morocco</title>
...
Royal Air Maroc (AT) operates regular internal flights from Casablanca airport to Agadir, Dakhla, Fes, Marrakech, Ouarzazate, Oujda and Tangier. Internal flights tend to be expensive compared to other modes of travelling around the country. <br><br>
Road: <br><br>
The Moroccan road network is extensive, and continued infrastructure development means that it’s increasingly easy to travel by car. Bear in mind that accident rates are high and road safety awareness among many drivers negligible, so nervous drivers may feel happier taking public transport or hiring a driver. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/morocco_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/morocco', 'Morocco') ?>&gt; Getting around</span></p>
