...
<meta name="description" content="Getting around in Mauritius"/>
<meta name="keywords" content="Getting around in Mauritius, Travel in Mauritius, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Mauritius</title>
...
Air Mauritius runs daily flights from Mauritius to Rodrigues.  Air Mauritius Helicopter provides transfers and sightseeing tours. <br><br>
Road quality: <br>
One major highway runs north to south, otherwise a good network of paved, if sometimes narrow, roads cover the island. <br><br>
Car hire: <br>
Abundant car hire firms include major international and independent firms. <br><br>
Taxi: <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mauritius_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mauritius', 'Mauritius') ?>&gt; Getting around</span></p>
