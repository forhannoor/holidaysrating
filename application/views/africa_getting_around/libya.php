...
<meta name="description" content="Getting around in Libya"/>
<meta name="keywords" content="Getting around in Libya, Travel in Libya, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Libya</title>
...
<div class="edit1"><p>  Air: <br><br>
Libyan Airlines, Afriqiyah, and Al Buraq fly between Tripoli and Benghazi. One-way fares are generally fixed on all routes at about 90 Libyan dinars. The flight time between Tripoli and Benghazi is about two hours. <br><br>
Road: <br><br>
Buses run from Tripoli to Benghazi which is a 10 to 12 hour drive. But the time is depends on traffic and the speed at which you are relaxed travelling. <br><br>
Side of road: <br><br>
Right <br><br>
Taxi: <br><br>
Taxis are easy to find. But you should fix the fare to avoid trouble. <br><br>
Bike: <br><br>
This might not be a good idea for the travelers. <br><br>
Coach: <br><br>
There are some bus services, mostly luxury, air-conditioned coaches between Tripoli and Benghazi and other main urban areas. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/libya_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/libya', 'Libya') ?>&gt; Getting around</span></p>
