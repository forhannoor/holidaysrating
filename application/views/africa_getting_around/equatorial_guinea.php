...
<meta name="description" content="Getting around in Equatorial Guinea"/>
<meta name="keywords" content="Getting around in Equatorial Guinea, Travel in Equatorial Guinea, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Equatorial Guinea</title>
...
There are flights between Malabo and Bata every day except Sunday; it is advisable to book in advance. <br><br>

Taxi: <br><br>
taxis connect Malabo with the island's two other main towns, Luba and Riaba, and also run from Bata to Mongomo and Ebebiyin; they can be hired hourly or daily. <br><br>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/equatorial_guinea_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/equatorial_guinea', 'Equatorial Guinea') ?>&gt; Getting around</span></p>
