...
<meta name="description" content="Getting around in Mauritania"/>
<meta name="keywords" content="Getting around in Mauritania, Travel in Mauritania, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Mauritania</title>
...
<div class="edit1">
<p>  Air: <br>
Mauritania Airlines International (L6) is the major airline in the country which also operates domestic flights. <br><br>
Side of road: <br>
Right <br><br>
Car hire: <br>
Cars are availabel in Nouakchott, Nouâdhibou and Atâr.  But hiring car is very expensive. <br><br>
Rail: <br>
There is a rail line between Nouâdhibou and Zouérat and is provided by the national mining company, SNIM, to serve the ore mines. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mauritania_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mauritania', 'Mauritania') ?>&gt; Getting around</span></p>
