...
<meta name="description" content="Getting around in Uganda"/>
<meta name="keywords" content="Getting around in Uganda, Travel in Uganda, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Uganda</title>
...
Fly Uganda, Eagle Air and Aerolink offer scheduled and charter internal flights. <br><br>
Road: <br>
Domestic bus travel is cheap, but departures aren’t always on schedule. There are two classes of bus travel – matatu (minibus) or kigati (van) which travel fixed routes, and larger coaches or buses. Self-drive and hiring a private car with a driver are other options. <br><br>
Side of road: <br>
Left <br><br><br>
Car hire: <br>
International hire companies are based near Entebbe International Airport and in the centre of Kampala. A four-wheel drive is recommended for rural areas. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/uganda_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/uganda', 'Uganda') ?>&gt; Getting around</span></p>
