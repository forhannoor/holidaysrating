...
<meta name="description" content="Getting around in Zambia"/>
<meta name="keywords" content="Getting around in Zambia, Travel in Zambia, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Zambia</title>
...
<div class="edit1">
<p>  Air: <br>
Zambia’s leading domestic carrier is Proflight, which offers scheduled flights to the main tourist hubs of Mfuwe and Livingstone. <br><br>
Road: <br>
Zambia’s major cities and tourist destinations are connected by a growing network of tarred or gravel highways and roads, making it straightforward to get from city to city by car. <br><br>
Side of road: <br>
Left <br><br>
Car hire: <br>
Several firms operate in main centres. <br><br>
Taxi: <br>
It’s easy to hire a taxi in Lusaka, Livingstone and the other major cities by booking over the phone, either direct or via your hotel. <br><br>
Bike: <br>
There are a few places in Livingstone where you can hire a bike and some safari lodges have mountain bikes for their guests to borrow, but this is not common. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/zambia_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/zambia', 'Zambia') ?>&gt; Getting around</span></p>
