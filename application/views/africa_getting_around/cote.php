...
<meta name="description" content="Getting around in Côte d'Ivoire"/>
<meta name="keywords" content="Getting around in Cote d'Ivoire, Travel in Cote d'Ivoire, Côte d'Ivoire, Ivorycoast, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Côte d'Ivoire</title>
...
<div class="edit1"><p>  Car hire: <br> <br>
<strong> Car hire: </strong> Cars are available for hire at the main towns and at the airport. <br> <br>
Taxi: <br> <br>
<strong> Taxi: </strong> These are available in main cities only <br> <br>
Documentation: <br> <br>
<strong> Documentation: </strong> Insurance is required for the drivers. Other important documents for the travelers may be required which needs to be attested. <br> <br>
<strong> Rail: </strong> <br> <br>
The Abidjan-Ouagadougou railway is one of the most efficient in Africa and runs trains daily from Abidjan to Bouaké and Ferkessédougou. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cote_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/cote_d_ivoire', 'Côte d Ivoire') ?>&gt; Getting around</span></p>
