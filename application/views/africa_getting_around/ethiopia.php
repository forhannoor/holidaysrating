...
<meta name="description" content="Getting around in Ethiopia"/>
<meta name="keywords" content="Getting around in Ethiopia, Travel in Ethiopia, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Ethiopia</title>
...
Ethiopian Airlines operates internal flights to 17 towns all through the country from their center at Addis Ababa Bole International Airport. <BR><BR>
Road: <BR><BR>
Ethiopia's roads are well developed now because of the government’s hard endeavor. <BR><BR>
Side of road: <BR><BR>Right 

Car hire: <BR><BR>
Self-driving car hire is only available within Addis Ababa<BR><BR>
Taxi: <BR><BR>
Private taxis are offered in Addis Ababa and other major towns. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/ethiopia_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/ethiopia', 'Ethiopia') ?>&gt; Getting around</span></p>
