...
<meta name="description" content="Getting around in Burundi"/>
<meta name="keywords" content="Getting around in Burundi, Travel in Burundi, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Burundi</title>
...
Currently there are no internal air flights. <BR><BR>
Side of road: Right <BR>
Road quality: <BR><BR>

Car hire: <BR><BR>

There are some local car services available but one can hardly find them. <BR><BR>

Taxi: <BR><BR>
Tanus-tanus (truck taxis) is seen but they are often crowded. <BR><BR>
Documentation: <BR><BR>
Driving licences issued by the UK are acceptable. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/burundi_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/burundi', 'Burundi') ?>&gt; Getting around</span></p>
