...
<meta name="description" content="Getting around in Benin"/>
<meta name="keywords" content="Getting around in Benin, Travel in Benin, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Benin</title>
...
<div class="edit1"><p>  <strong> Bush taxi, minibus & bus </strong> <BR><BR>
Minibuses and bush taxis are available in the country. And they are the major means of transport between towns. A bush taxi from Cotonou costs CFA600 to Ouidah, CFA2000 to Abomey and CFA6500 to Parakou, while minibuses cost about 25% less and take longer. There is sometimes a surcharge for carrying bags. <BR><BR>
Confort Lines buses run between Cotonou and Natitingou via Savalou (CFA7500, 10 hours), stopping in all major towns en route. Benin Routes has daily buses between Cotonou and Parakou (CFA5500, five hours). <BR><BR>
<strong> Car & motorcycle </strong> <BR><BR>
Petrol costs CFA300 to CFA600 per litre, with prices generally rising as you travel north. Nigerian petrol is sold on the black market at prices somewhat below the official rate. Search for the guys along the roads with 1L to 5L bottles. <BR><BR>
International Driving Permit (IDP) is needed if you are driving. Roads are in good condition throughout Benin. </p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/benin_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/benin', 'Benin') ?>&gt; Getting around</span></p>
