...
<meta name="description" content="Getting around in Rwanda"/>
<meta name="keywords" content="Getting around in Rwanda, Travel in Rwanda, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Rwanda</title>
...
Akagera Aviation (+250 788 308 382 / +250 252 580 234) provides helicopter flights all over the country. Rwandair flies internally to the southeastern town of Cyangugu. <br><br>
Road: <br>
There is a lot of work being done to improve the roads, and in some places you will find smooth tarmac, while in others you will be going along pot-holed dirt paths. Extra care should be taken at night, as headlight use is erratic. During rainy season some roads can become impassable. <br><br>
Side of road: <br>
Right <br><br>

Car hire: <br>
There are no international car hire companies operating in Rwanda, but there are several local companies. You will find these listed in the Eye magazine given away at the airport and in hotels. <br><br>
Taxi: <br>
Taxis can be found in large towns and cities, look for the official orange stripe. <br><br>
Bike: <br>
Bicycle and scooter taxis are the quickest and cheapest way to get around in the towns, however they are risky. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/rwanda_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/rwanda', 'Rwanda') ?>&gt; Getting around</span></p>
