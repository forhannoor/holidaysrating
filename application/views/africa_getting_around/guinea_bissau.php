...
<meta name="description" content="Getting around in Guinea Bissau"/>
<meta name="keywords" content="Getting around in Guinea Bissau, Travel in Guinea Bissau, Transport, Bus, Taxi, Guinea-Bissau"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Guinea Bissau</title>
...
The national airline gives internal flights, including to the outlying islands. <BR><BR>
Side of road: <BR><BR>
Right <BR><BR>

Car hire: <BR><BR>
Car hire: Expensive and limited to Bissau. <BR><BR>
Coach: <BR><BR>
local and long-distance taxis and buses are available. <BR><BR>
By water: <BR><BR>
Most towns are easy to get by ship. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/guinea_bissau_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/guinea_bissau', 'Guinea Bissau') ?>&gt; Getting around</span></p>
