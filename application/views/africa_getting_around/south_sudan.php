...
<meta name="description" content="Getting around in South Sudan"/>
<meta name="keywords" content="Getting around in South Sudan, Travel in South Sudan, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | South Sudan</title>
...
<p>  Air: <br>
Internal flights are the easiest way to get around South Sudan. <br><br>
Side of road: <br>
Right <br><br>
Car hire: <br>
Available in Juba. <br><br>
Taxi: <br>
Urban taxis in Juba are plentiful, along with motorbike taxis. Road safety is not always a primary concern of drivers. Taxis are not metered; fares must be agreed in advance. <br><br>
Coach: <br>
Rough and ready minibuses connect Juba to towns in the south. During the May-December rainy season, roads can become impassable and certain destinations (such as Wau) only accessible by air. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/south_sudan_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/south_sudan', 'South Sudan') ?>&gt; Getting around</span></p>
