...
<meta name="description" content="Getting around in Tunisia"/>
<meta name="keywords" content="Getting around in Tunisia, Travel in Tunisia, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Tunisia</title>
...
The national airline TunisAir and their subsidiary airline TunisAir Express are the only airlines operating domestic routes within Tunisia. From their hub at Tunis-Carthage Airport they have internal flights to Djerba, Monastir, Sfax, and Tozeur. <br><br>
Car hire: <br>
Major international and local companies can be found at all international airports and within bigger towns. <br><br>
Taxi: <br>
There are two kinds of taxis in Tunisia. Private metered taxis are readily available within towns and cities and are reasonably priced. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/tunisia_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/tunisia', 'Tunisia') ?>&gt; Getting around</span></p>
