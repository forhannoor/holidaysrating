...
<meta name="description" content="Getting around in Togo"/>
<meta name="keywords" content="Getting around in Togo, Travel in Togo, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Togo</title>
...
Air Togo runs services to Sokodé, Mango, Dapango, Lama-Kara, Lomé and Niamtougou. <br><br>
Side of road: <br>
Right <br><br>
Car hire: <br>
Car hire: This is available in Lomé; elsewhere the cost of car hire is very high and it is usually better to hire a taxi. <br><br>
Taxi: <br>
Bus/taxi: National bus, minibus and taxi systems are reasonably efficient and cheap. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/togo_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/togo', 'Togo') ?>&gt; Getting around</span></p>
