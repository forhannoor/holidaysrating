...
<meta name="description" content="Getting around in Cameroon"/>
<meta name="keywords" content="Getting around in Cameroon, Travel in Cameroon, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Cameroon</title>
...
<div class="edit1">Air: <br>
Cameroon may satisfy you with its air transport facilities. Elysian Airlines  runs services to many destinations within Cameroon including Douala, Yaoundé, Garoua and Maroua. <br><br>
Departure tax: <br>
CFA500.<br><br>
Side of road: <br>
 Right<br><br>
Road quality: <br>
Some roads are not maintained properly due to heavy rain.<br><br> 
Car hire: <br>
This is costly and restricted to Douala, Yaoundé and Limbé. Cars are available with or without a driver. 
Documentation: 
An International Driving Permit could be wanted by authority. <br><br>
Rail: <br>
Cameroon Railways is the national service provider. It provides good quality services. But is is relatively slow, yet it is still much quicker to go by train than by bus. 
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cameroon_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/cameroon', 'Cameroon') ?>&gt; Getting around</span></p>
