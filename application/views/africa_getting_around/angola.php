...
<meta name="description" content="Getting around in Angola"/>
<meta name="keywords" content="Getting around in Angola, Travel in Angola, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Angola</title>
...
Available cars are waiting for the tourists. Most of the hotels have their own services. Some services are aided by Chinese and Portuguese investment.  Available cars now make the journey up from Namibia, and roads are passable (if rough) between the cities of Lubango, Huambo, Benguela, Lobito, Luanda and Malange. <br><br>
<strong>Bus</strong> <br>
Public transportation is still a matter of puzzle here. Though compared to other African buses, the vehicles in Angola are relatively comfortable.</p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/angola_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/angola', 'Angola') ?>&gt; Getting around</span></p>
