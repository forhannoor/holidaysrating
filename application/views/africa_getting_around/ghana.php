...
<meta name="description" content="Getting around in Ghana"/>
<meta name="keywords" content="Getting around in Ghana, Travel in Ghana, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Ghana</title>
...
Air services between Accra, Takoradi, Kumasi and Tamale are run by Starbow <br><br>
Road: <br><br>
The only way to reach most sites of interest in Ghana is by road. Keeping a map is a good idea. <br><br>
Side of road: <br><br>
Right <br><br>
Car hire: <br><br>
Hiring a car is so expensive. Car with driver and without driver are found. <br><br>
Taxi: <br><br>
Taxis are seen throughout Ghana. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/ghana_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/ghana', 'Ghana') ?>&gt; Getting around</span></p>
