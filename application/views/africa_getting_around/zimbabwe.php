...
<meta name="description" content="Getting around in Zimbabwe"/>
<meta name="keywords" content="Getting around in Zimbabwe, Travel in Zimbabwe, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Zimbabwe</title>
...
<div class="edit1"><p>  
Air: <br>
Air Zimbabwe has resumed domestic flights to Bulawayo, Harare and Victoria Falls but the national airline has ceased much of the rest of its domestic operation. There are special light-aircraft services at Kariba and Victoria Falls offering sightseeing and game-viewing flights. <br><br>
Side of road: <br>
Left <br><br>
Car hire: <br>
Car hire: Available at airports and main hotels. <br><br>
Coach: <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/zimbabwe_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/zimbabwe', 'Zimbabwe') ?>&gt; Getting around</span></p>
