...
<meta name="description" content="Getting around in Sierra Leone"/>
<meta name="keywords" content="Getting around in Sierra Leone, Travel in Sierra Leone, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Sierra Leone</title>
...
Private airlines can be chartered, connecting Hastings, Bo, Kenema, Yengema and Freetown airports. <br><br>
Road: <br>
Travelling by road in Sierra Leone can be a daunting task, but there are a number of good quality tarmacked roads that connect the major cities together, and a good network of dirt roads connecting the smaller more remote towns and villages. <br><br>
Side of road: <br>
Right <br><br>
Car hire: <br>
Car hire (with driver) is available<br><br>
Taxi: <br>
In major towns there are reliable taxi services that travel predetermined routes. Taxis are yellow and black, and range from five-seaters to people carriers. <br><br>
Documentation: <br>
A valid International Driving Permit is required. <br><br>

Rail: <br>
There are currently no commercial rail services in Sierra Leone. <br><br>
By water: <br>
Ferries connect the coastal ports of Freetown, Pepel and Sherbro Islands. For details, contact local authorities or the National Tourist Board of Sierra Leone. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sierra_leone_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sierra_leone', 'Sierra Leone') ?>&gt; Getting around</span></p>
