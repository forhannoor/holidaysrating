...
<meta name="description" content="Getting around in Gabon"/>
<meta name="keywords" content="Getting around in Gabon, Travel in Gabon, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Gabon</title>
...
Air Gabon has available flights from Lambaréné, Libreville, Mitzic, Oyem and other cities. local airports are at Franceville (MVB) and Port Gentil (POG). <BR><BR>
Side of road: <BR><BR>

Right <BR><BR>

Car hire: <BR><BR>
Cars can be hired but they are expensive and are found associated with hotels. <BR><BR>
Documentation: <BR><BR>
International Driving Permit and international insurance are required. <BR><BR>
Rail: <BR><BR>
The Trans-Gabon Railway is the only railway line in Gabon<BR><BR>
By water: <BR><BR>
Ferries operate frequently along the coast from Libreville to Port Gentil (journey time - 4 hours). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/gabon_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/gabon', 'Gabon') ?>&gt; Getting around</span></p>
