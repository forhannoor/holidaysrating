...
<meta name="description" content="Getting around in São Tomé and Príncipe"/>
<meta name="keywords" content="Getting around in São Tomé and Príncipe, Travel in São Tomé and Príncipe, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | São Tomé and Príncipe</title>
...
There is no national airline but the islands can be reached with TAP Portugal. <br><br>
Side of road: <br>
Right <br><br>
Car hire: <br>
Car can be arranged through the Miramar Hotel in the capital. <br><br>
Taxi: <br>
Bus/taxi: There is a bus network and yellow share taxis are also in operation. The only public transport on Príncipe is a minibus. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sao_tome_and_principe_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sao_tome_and_principe', 'São Tomé and Príncipe') ?>&gt; Getting around</span></p>
