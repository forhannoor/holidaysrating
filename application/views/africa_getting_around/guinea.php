...
<meta name="description" content="Getting around in Guinea"/>
<meta name="keywords" content="Getting around in Guinea, Travel in Guinea, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Guinea</title>
...
Guinee Airlines runs internal services to some of the main towns. <br><br>
Side of road: <br><br>
Right <br><br>
Taxi: <br><br>
Taxis are not hard to find, but fares should be fixed in advance. Bush taxis typically cover smaller distances than coaches and can take up to seven passengers. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/guinea_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/guinea', 'Guinea') ?>&gt; Getting around</span></p>
