...
<meta name="description" content="Getting around in Central African Republic"/>
<meta name="keywords" content="Getting around in Central African Republic, Travel in Central African Republic, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Central African Republic</title>
...
<div class="edit1"><p>  <strong> Air: </strong> <br>
Scheduled flights to Berbérati are available. <br><br>
<strong> Road: </strong> <br>

There have been reports on crime on the roads. Tourists should be careful because of this. Rain water causes trouble regularly. <br><br>

<strong> Side of road: </strong> <br>
Right <br><br>

<strong> Road quality: </strong> <br>
Roads generally connect main towns, but the majority is often blocked in the rainy season and travelers should expect delays. <br><br>
<strong> Car hire: </strong> <br>
Self-driven cars are available and cars can also be hired. <br><br>
<strong> Documentation: </strong> <br>
Driving Permit is essential for foreigners. Other documents could be necessary for the foreigners. <br><br>
<strong> Getting around towns and cities: </strong> <br>
Limited bus services are available in the country which run in Bangui on a two-zone tariff. Taxis are only available in the urban areas; they do not have meters and fares must be negotiated. Minibuses serve Bangui and other major towns. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/car_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/central_african_republic', 'Central African Republic') ?>&gt; Getting around</span></p>
