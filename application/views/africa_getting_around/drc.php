...
<meta name="description" content="Getting around in Democratic Republic of Congo"/>
<meta name="keywords" content="Getting around in Democratic Republic of Congo, Travel in Democratic Republic of Congo, DRC, D.R.C., Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Democratic Republic of Congo</title>
...
The national airline, Lina Congo (GC), operates regular services from Brazzaville to Pointe-Noire, with stops in Loubomo and Ouesso. Private charters are available. <br> <br>
<strong> Side of road: </strong> <br>
Right <br> <br>

<strong> Car hire: </strong> <br>
There are several car hire firms represented in Brazzaville <br> <br>
<strong> Documentation: </strong> <br>
An International Driving Permit is required. <br> <br>
<strong> Taxi services:</strong> <br>
Taxis are seen in Pointe-Noire and Loubomo. <br> <br>
<strong> Rail: </strong> <br>
Congo-Océan railway company runs services between Brazzaville and Pointe-Noire (journey time - up to 3 days). <br> <br>
<strong> By water: </strong> <br>
Inland steamers run from Brazzaville up the Congo and Ubangi. Rivers play vital role to internal transport. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/drc_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/democratic_republic_of_congo', 'Democratic Republic of Congo') ?>&gt; Getting around</span></p>
