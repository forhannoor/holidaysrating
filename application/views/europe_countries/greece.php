...
<meta content="<?php echo base_url() ?>assets/images/flags/europe/greece.gif" property="og:image" />

<title>Greece | Europe</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/greece/mykonos.jpg" title="Mykonos"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Mykonos in Greece</h1>
                            	Explore the many things Greece has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/greece/meteora.jpg" title="Meteora"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Meteora in Greece</h1>
                                Greece in Europe. is this your next travel destination?</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/greece/bay.jpg" title="Greece"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Beautiful coastline of greece</h1>
                                Greece is the perfect destination if you like to enjoy sun, sea and culture!</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/greece/greece.jpg" title="Greece"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Greece in Europe is the place to be..</h1>
                                Share your Greece holiday experience. Publish it on Holidaysrating!</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/europe/greece.jpg" alt="Greece" />
<p style="float:right;width:75%"><strong>Greece</strong> is a country in Southeast <?php echo anchor('regions/europe', 'Europe') ?>, with a size of 131,957 square kilometres.</p>
<br />
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/greece', 'Leave a comment') ?>
</div>
...
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/europe', 'Europe') ?>&gt; Greece</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=greece&amp;aq=&amp;sll=51.165691,10.451526&amp;sspn=8.988482,26.784668&amp;ie=UTF8&amp;hq=&amp;hnear=Greece&amp;t=m&amp;ll=39.300299,22.280273&amp;spn=4.080495,7.646484&amp;z=5&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=greece&amp;aq=&amp;sll=51.165691,10.451526&amp;sspn=8.988482,26.784668&amp;ie=UTF8&amp;hq=&amp;hnear=Greece&amp;t=m&amp;ll=39.300299,22.280273&amp;spn=4.080495,7.646484&amp;z=5" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
