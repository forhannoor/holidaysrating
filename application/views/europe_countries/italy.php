        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/italy/cinque-terre.jpg" title="Italy"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Italy</h1>
                            	Enjoy of the many thing Italy has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/italy/colosseum.jpg" title="Colosseum"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Rome, Italy</h1>
                                Visit the colosseum in Rome.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/italy/italy.jpg" title="Italy"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Italy, Europe</h1>
                                Holidaysrating recommand; italy in europe.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/italy/lake-garda.jpg" title="Lake Garda"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Lake garda in Italy</h1>
                                This is a populair holiday destination.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/europe/italy.jpg" alt="Italy" />
<p style="float:right;width:75%"><strong>Italy</strong> is a country in Southern <?php echo anchor('regions/europe', 'Europe') ?>, with a size of 301,338 square kilometres.</p>
<br />
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/italy', 'Leave a comment') ?>
</div>
...
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/europe', 'Europe') ?>&gt; Italy</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=italy&amp;aq=&amp;sll=53.41291,-8.24389&amp;sspn=4.269999,13.392334&amp;ie=UTF8&amp;hq=&amp;hnear=Italy&amp;t=m&amp;ll=42.875964,11.777344&amp;spn=7.728228,15.292969&amp;z=4&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=italy&amp;aq=&amp;sll=53.41291,-8.24389&amp;sspn=4.269999,13.392334&amp;ie=UTF8&amp;hq=&amp;hnear=Italy&amp;t=m&amp;ll=42.875964,11.777344&amp;spn=7.728228,15.292969&amp;z=4" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
