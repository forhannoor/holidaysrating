...
<meta content="<?php echo base_url() ?>assets/images/flags/europe/slovakia.gif" property="og:image" />

<title>Slovakia | Europe</title>
        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/slovakia/oravsky-podzamok.jpg" title="Slovakia"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to Slovakia</h1>
                            	Are you ready for a life changing travel experience? Slovakia is the destination to be. Tell us your travel expeience...</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/slovakia/tatranska.jpg" title="Tatranska"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Slovakia, Europe</h1>
                                Enjoy the many things Slovakia has got to offer.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/slovakia/lake.jpg" title="Slovakia"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Lake in Slovakia</h1>
                                Visit Slovakia in Europe.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/slovakia/slovakia.jpg" title="Slovakia"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Is Slovakia your next holiday destination?</h1>
                                Review Slovakia here.</div>                                          	                          
                        </li>     
                    </ul>
                </div>     
            </div>
...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/europe/slovakia.jpg" alt="Slovakia" />
<p style="float:right;width:75%"><strong>Slovakia</strong> is a landlockedcountry in Central <?php echo anchor('regions/europe', 'Europe') ?>, with a size of 49,035 square kilometres.</p>
<br />
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/slovakia', 'Leave a comment') ?>
</div>
...
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/europe', 'Europe') ?>&gt; Slovakia</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=slovakia&amp;aq=&amp;sll=44.016521,21.005859&amp;sspn=5.151141,13.392334&amp;ie=UTF8&amp;hq=&amp;hnear=Slovakia&amp;t=m&amp;ll=48.676454,19.160156&amp;spn=1.741072,3.823242&amp;z=6&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=slovakia&amp;aq=&amp;sll=44.016521,21.005859&amp;sspn=5.151141,13.392334&amp;ie=UTF8&amp;hq=&amp;hnear=Slovakia&amp;t=m&amp;ll=48.676454,19.160156&amp;spn=1.741072,3.823242&amp;z=6" style="color:#0000FF;text-align:left">View Larger Map</a></small>
