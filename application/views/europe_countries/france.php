        ...
        <div class="wt-rotator">
            ...
            <div class="c-panel">
                ...
                <div class="thumbnails">
                    <ul>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/france/alps.jpg" title="Alps"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract17.jpg"/></a>
                            <a href="#" target="_blank"></a>                        
                            <div style="left:5px; top:94px; width:336px; height:0;"> 
                            	<h1>Travel to the Alps in france</h1>
                            	Explore the many things France has got to offer.</div>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/france/chateau.jpg" title="France"><img src="<?php echo base_url() ?>assets/images/thumbs/sf.jpg"/></a>
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF"> 
                                <h1 style="color:#0CF">Chateau in France</h1>
                                Chateau in France. Holidaysrating recommand France.</div>                                                  	
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/france/eiffeltower.jpg" title="Eiffeltower"><img src="<?php echo base_url() ?>assets/images/thumbs/triworks_abstract26.jpg"/></a>   
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                            	<h1 style="color:#0CF">Eiffeltower in Paris, France</h1>
                                Visit the eiffeltower.</div>                                                          	                   
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>assets/images/countries/europe/france/nice.jpg" title="Nice"><img src="<?php echo base_url() ?>assets/images/thumbs/tokyo.jpg"/></a>                  
                            <a href="#" target="_blank"></a>
                            <div style="left:5px; top:36px; width:350px; height:0;"> 
                                <h1>Nice a town on the coast of France</h1>
...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/europe/france.jpg" alt="France" />
<p style="float:right;width:75%"><strong>France</strong> is a country in Western <?php echo anchor('regions/europe', 'Europe') ?>, with several overseas regions and territories. France has got a size of 640,679 square kilometres.</p>
<br />
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/france', 'Leave a comment') ?>
</div>
...
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/europe', 'Europe') ?>&gt; France</span></p>

<iframe width="175" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.au/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=france&amp;aq=&amp;sll=61.92411,25.748151&amp;sspn=27.551061,107.138672&amp;ie=UTF8&amp;hq=&amp;hnear=France&amp;t=m&amp;ll=46.589069,2.460938&amp;spn=3.624114,7.646484&amp;z=5&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.au/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=france&amp;aq=&amp;sll=61.92411,25.748151&amp;sspn=27.551061,107.138672&amp;ie=UTF8&amp;hq=&amp;hnear=France&amp;t=m&amp;ll=46.589069,2.460938&amp;spn=3.624114,7.646484&amp;z=5" target="_blank" style="color:#5F6A6F;text-align:left">View Larger Map</a></small>
