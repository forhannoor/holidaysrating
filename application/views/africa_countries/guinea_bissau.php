...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/guinea-bissau.jpg" alt="Guinea Bissau" /></div>

<div class="edit1">
<p><strong>Guinea-Bissau</strong> is located in west <a href="http://www.holidaysrating.com/index.php/regions/africa">Africa</a> and has a size of 36,125 square kilomtres. <a href="http://www.holidaysrating.com/index.php/africa_cities/bissau">Bissau</a> is the capital and largest city. The official language is Portugese but French and Kriol are more commonly spoken.<br><br>
Not to be confused with it's neighbour <a href="http://www.holidaysrating.com/index.php/africa_countries/guinea">Guinea</a> or <a href="http://www.holidaysrating.com/index.php/africa_countries/equatorial_guinea">Equatorial Guinea</a>.</p>
</div>
...
<ul>
<li><?php echo anchor('africa_before_you_go/guinea_bissau', img('assets/images/countries/menu/before-you-go.png')); ?></li>
<li><?php echo anchor('africa_entry/guinea_bissau', img('assets/images/countries/menu/entry.png')); ?></li>
<li><?php echo anchor('africa_adventures/guinea_bissau', img('assets/images/countries/menu/adventures.png')); ?></li>
<li><?php echo anchor('africa_must_see/guinea_bissau', img('assets/images/countries/menu/must-see.png')); ?></li>
</ul>
<ul>
<li><?php echo anchor('africa_getting_around/guinea_bissau', img('assets/images/countries/menu/getting-around.png')); ?></li>
<li><?php echo anchor('africa_health/guinea_bissau', img('assets/images/countries/menu/health.png')); ?></li>
<li><?php echo anchor('africa_local_food/guinea_bissau', img('assets/images/countries/menu/food.png')); ?></li>
<li><?php echo anchor('africa_public_holidays/guinea_bissau', img('assets/images/countries/menu/holidays.png')); ?></li>
</ul>
</div>
...
<div class="edit3">
<p>The country has a rich biodiversity. Thick jungle in the interior plains, rice and mangrove fields along the coastal plains and swamps, and savanna in the North. Guinea Bissau is home to wildlife such as antelopes, buffalo, monkeys, snakes and many migrating birds.</p>
</div>
...
<?php echo anchor('africa_national_parks/guinea_bissau', '(Go to National Parks)') ?>
...
<li><img src="<?php echo base_url() ?>assets/assets/city.png" style="margin-right:5px" alt="city"/><?php echo anchor('africa_cities/bissau', 'Bissau') ?></li>

<li><strong>Size:</strong></li>
<li><img src="<?php echo base_url() ?>assets/assets/size.png" style="margin-right:5px" alt="size"/>36,125 km²</li>
<li><img src="<?php echo base_url() ?>assets/assets/size.png" style="margin-right:5px" alt="size"/>13,948 sq mi</li>

<li><strong>Water:</strong></li>
<li><img src="<?php echo base_url() ?>assets/assets/water.png" style="margin-right:5px" alt="water"/>22.4%</li>
...
<h2 style="margin-bottom:5px">Guinea Bissau</h2>
<div class="edit4">
<p>This former Portuguese colony is one of the smallest countries in Africa; however it offers a number of things to do and see. Visitors will be amazed to see a mix of nature and culture. </p>
</div>
