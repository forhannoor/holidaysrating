...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/ghana.jpg" alt="Ghana" /></div>

<div class="edit1">
<p><strong>Ghana</strong> is a country in west <a href="http://www.holidaysrating.com/index.php/regions/africa">Africa</a> with a size of 238,535 square kilomtres and consist several islands. English is the official language spoken in the Ghana, however, nine other official languages are spoken by the local population: Akan, Dagomba (Dagbani), Dangme, Dagaare,Ewe, Ga, Gonja, Kasem and Nzema. Ghana is an ideal destination for first-time visitors to Africa. Friendly, safe and inexpensive. <a href="http://www.holidaysrating.com/index.php/africa_cities/accra">Accra</a> is the capital and largest city of the country and has a wide range of nightclubs, restaurants and hotels.<br><br>
...
<ul>
<li><?php echo anchor('africa_before_you_go/ghana', img('assets/images/countries/menu/before-you-go.png')); ?></li>
<li><?php echo anchor('africa_entry/ghana', img('assets/images/countries/menu/entry.png')); ?></li>
<li><?php echo anchor('africa_adventures/ghana', img('assets/images/countries/menu/adventures.png')); ?></li>
<li><?php echo anchor('africa_must_see/ghana', img('assets/images/countries/menu/must-see.png')); ?></li>
</ul>
<ul>
<li><?php echo anchor('africa_getting_around/ghana', img('assets/images/countries/menu/getting-around.png')); ?></li>
<li><?php echo anchor('africa_health/ghana', img('assets/images/countries/menu/health.png')); ?></li>
<li><?php echo anchor('africa_local_food/ghana', img('assets/images/countries/menu/food.png')); ?></li>
<li><?php echo anchor('africa_public_holidays/ghana', img('assets/images/countries/menu/holidays.png')); ?></li>
</ul>
</div>

<h1>Climate</h1>
<div class="edit2">
<p>The climate is mild tropical. The wet and the dry seasons are the two main seasons. March to November is a time for rain in North Ghana while South Ghana observes its rainy season from April to November. The harmattan, a dry desert wind, blows in Northeastern Ghana from December to March, lowering the humidity and causing hot days and cool nights. Temperatures range from 21°C to 28°C in the daytime with a relative humidity between 77% and 85%. there are two rainy seasons: from April to June and September through November in the northern part of Ghana. </p>
</div>
...
Wildlife includes lions, leopards, buffaloes, elephants, duiker, numerous antelopes and many primates.</p>
</div>
...
<?php echo anchor('africa_national_parks/ghana', '(Go to National Parks)') ?>
...
<li><img src="<?php echo base_url() ?>assets/assets/city.png" style="margin-right:5px" alt="city"/><?php echo anchor('africa_cities/accra', 'Accra') ?></li>

<li><strong>Size:</strong></li>
<li><img src="<?php echo base_url() ?>assets/assets/size.png" style="margin-right:5px" alt="size"/>238,535 km²</li>
<li><img src="<?php echo base_url() ?>assets/assets/size.png" style="margin-right:5px" alt="size"/>92,099 sq mi</li>

<li><strong>Water:</strong></li>
<li><img src="<?php echo base_url() ?>assets/assets/water.png" style="margin-right:5px" alt="water"/>4.61%</li>
...
<h2 style="margin-bottom:5px">Explore Ghana</h2>
<div class="edit4">
<p>Ghana is historically and naturally diverse country, Ghana always attracts tourists’ fancy with its prestigious heritage. Ghana is small but there are no shortage of attractions.</p>
</div>
