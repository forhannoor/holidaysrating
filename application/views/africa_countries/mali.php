...
<meta name="description" content="Mali, Africa"/>
...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/africa/mali.jpg" alt="Mali" /></div>

<div class="edit1">
<p><strong>Mali</strong> is a landlocked country in west <a href="http://www.holidaysrating.com/index.php/regions/africa">Africa</a>, with a size of 1,240,192 square kilometres. <a href="http://www.holidaysrating.com/index.php/africa_cities/bamako">Bamako</a> is the largest and capital city. The official language is French but Bambara and other indiginous languages are also commonly spoken.</p>
</div>
...
<ul>
<li><?php echo anchor('africa_before_you_go/mali', img('assets/images/countries/menu/before-you-go.png')); ?></li>
<li><?php echo anchor('africa_entry/mali', img('assets/images/countries/menu/entry.png')); ?></li>
<li><?php echo anchor('africa_adventures/mali', img('assets/images/countries/menu/adventures.png')); ?></li>
<li><?php echo anchor('africa_must_see/mali', img('assets/images/countries/menu/must-see.png')); ?></li>
</ul>
<ul>
<li><?php echo anchor('africa_getting_around/mali', img('assets/images/countries/menu/getting-around.png')); ?></li>
<li><?php echo anchor('africa_health/mali', img('assets/images/countries/menu/health.png')); ?></li>
<li><?php echo anchor('africa_local_food/mali', img('assets/images/countries/menu/food.png')); ?></li>
<li><?php echo anchor('africa_public_holidays/mali', img('assets/images/countries/menu/holidays.png')); ?></li>
</ul>
</div>

<h1>Climate</h1>
<div class="edit3">
<p>Mali has a tropical climate with distinct summer and winter months. The country has three main seasons. Rainy season lasts from June to October. The cold winter season is generally between October and February, which is followed by tremendously hot and dry climate till June. Depending upon the latitudes, Mali climate is different from one place to another. Northern Sahara zone in Mali experiences hot and dry climate where as the subtropical Southern part is hot and humid. The climate in Mali is hot with average temperatures ranging between 24° and 32°C.<br><br>
...
<div class="edit4">
<p>The Saharan zone within the country, an area of fixed dunes and false steppes, contains vegetation made up of thick-leaved and thorny plants, like mimosas and gum trees. The vegetation of the Sahelian zone resembles that of the steppes, with thorny plants and shrubby savannas. There remains the Sudanese zone is an area of herbaceous vegetation; trees of this place are bastard baobab, mahogany, kapok and shea.
...
<?php echo anchor('africa_national_parks/mali', '(Go to National Parks)') ?>
...
<li><img src="<?php echo base_url() ?>assets/assets/city.png" style="margin-right:5px" alt="city"/><?php echo anchor('africa_cities/bamako', 'Bamako') ?></li>

<li><strong>Size:</strong></li>
<li><img src="<?php echo base_url() ?>assets/assets/size.png" style="margin-right:5px" alt="size"/>1,240,192 km²</li>
<li><img src="<?php echo base_url() ?>assets/assets/size.png" style="margin-right:5px" alt="size"/>478,839 sq mi</li>

<li><strong>Water:</strong></li>
<li><img src="<?php echo base_url() ?>assets/assets/water.png" style="margin-right:5px" alt="water"/>1.6%</li>
...
<h2 style="margin-bottom:5px">Explore Mali</h2>
<div class="edit5">
<p>Many ancient structures were destroyed but the tourists have a number of things to get wondered in Mali</p>
</div>
