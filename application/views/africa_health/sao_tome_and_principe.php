...
<meta name="description" content="São Tomé and Príncipe Health"/>
<meta name="keywords" content="São Tomé and Príncipe Health, Health in São Tomé and Príncipe, First Aid in São Tomé and Príncipe, Doctor, Hospital"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Health | São Tomé and Príncipe</title>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sao_tome_and_principe_health', 'Leave a comment') ?>
</div>
...
<div class="top-health"></div>
<div class="middle-health">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sao_tome_and_principe', 'São Tomé and Príncipe') ?>&gt; Health</span></p>
