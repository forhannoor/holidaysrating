...
<meta name="description" content="Chad Health"/>
<meta name="keywords" content="Algeria Chad, Health in Chad, First Aid in Chad, Doctor, Hospital"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Health | Chad</title>
...
<div class="edit1"><p>  Be aware of water as it is contaminated. Therefore, water must e boiled before drinking. Milk is unpasteurized and need to be boiled. <BR><BR>
Medical facilities are not modern, mostly in the north, and health is necessary. <BR><BR>
Other risks: <BR>
Bilharzia (schistosomiasis) is found in the country, but only in the
south and southeast of the country. Travelers must skip swimming in
fresh water as water can have strong bacteria. Meningococcal meningitis is seen, particularly in the savannah areas during the dry season (November to May). hepatitis B and tuberculosis should be considered for longer visits. Hepatitis E is common in the region (especially in the north and east of
Chad). HIV/AIDS is prevalent. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/chad_health', 'Leave a comment') ?>
</div>
...
<div class="top-health"></div>
<div class="middle-health">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/chad', 'Chad') ?>&gt; Health</span></p>
