...
<meta name="description" content="Zanzibar Health"/>
<meta name="keywords" content="Zanzibar Health, Health in Zanzibar, First Aid in Zanzibar, Doctor, Hospital"/>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/zanzibar_health', 'Leave a comment') ?>
</div>
...
<div class="top-health"></div>
<div class="middle-health">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/zanzibar', 'Zanzibar') ?>&gt; Health</span></p>
