...
<meta name="description" content="Comoros Health"/>
<meta name="keywords" content="Comoros Health, Health in Comoros, First Aid in Comoros, Doctor, Hospital"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Health | Comoros</title>
...
<div class="edit1"><p>  A yellow fever vaccination certificate is essential from all travelers over one year of age travelling from infected areas. The heat and dust may cause problems for some people. Visitors should use sun protection, especially due to Comoros's high altitude. The public health system is good. All main towns have chemists, and pharmaceutical supplies are readily available. Health insurance is essential. <br><br>

travelers should be vaccinated for the following diseases: <br><br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/comoros_health', 'Leave a comment') ?>
</div>
...
<div class="top-health"></div>
<div class="middle-health">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/comoros', 'Comoros') ?>&gt; Health</span></p>
