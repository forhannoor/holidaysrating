...
<meta name="description" content="Central African Republic Health"/>
<meta name="keywords" content="Central African Republic Health, Health in Central African Republic, First Aid in Central African Republic, Doctor, Hospital"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Health | Central African Republic</title>
...
<div class="edit1"><p>  Health insurance is a good idea and required by authorities. Tourists should have sufficient first aid and basic medicines with them because medical services are not good at all. Dysentery and stomach ache are common problems. <BR><BR>
Hepatitis viruses are seen n the country. Tourists should not swim the water since water is contaminated by a number of diseases.  Milk must be boiled because it is not pasteurized. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/car_health', 'Leave a comment') ?>
</div>
...
<div class="top-health"></div>
<div class="middle-health">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/cantral_african_republic', 'Central African Republic') ?>&gt; Health</span></p>
