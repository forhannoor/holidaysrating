...
<meta name="description" content="Algeria Health"/>
<meta name="keywords" content="Algeria Health, Health in Algeria, First Aid in Algeria, Doctor, Hospital"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Health | Algeria</title>
...
<div class="edit1">
<p>Get travel vaccines and medicines because there is a risk of these diseases in the country you are visiting.<br><br>
•	Hepatitis A<br> 	
CDC recommends this vaccine because you can get hepatitis A through contaminated food or water in Algeria, regardless of where you are eating or staying.<br><br>
•	Typhoid<br>	
You can get typhoid through contaminated food or water in Algeria. CDC recommends this vaccine for most travelers, especially if you are staying with friends or relatives, visiting smaller cities or rural areas, or if you are an adventurous eater.<br><br>
•	Yellow Fever<br>	
There is no risk of yellow fever in Algeria. The government of Algeria requires proof of yellow fever vaccination only if you are arriving from a country with risk of yellow fever. This does not include the US. If you are traveling from a country other than the US, check this list to see if you may be required to get the yellow fever vaccine: Countries with risk of yellow fever virus (YFV) transmission. </p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/algeria_health', 'Leave a comment') ?>
</div>
...
<div class="top-health"></div>
<div class="middle-health">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/algeria', 'Algeria') ?>&gt; Health</span></p>
