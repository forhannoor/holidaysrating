...
<meta name="description" content="Must see in Libya"/>
<meta name="keywords" content="Must see, Libya destinations, Travel to Libya"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Libya</title>
...
<div class="edit1"><p>  Ghadames <br>
Leptis Magna <br>
Roman Libya <br>
Snorkelling <br>
Souk shopping <br>
The Pentapolis <br>
Trekking and caves <br>
Ubari sand dunes & lakes <br>
Ancient cities <br>
Freedom Square (Green Square) <br>
Qasr Libya <br>
Akakus Mountains <br>
Assai al-Hamra (Red Castle) <br>
Beaches <br>
Berber architecture <br>
Camel riding <br>
Desert driving <br>
Dune-surfing </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/libya_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/libya', 'Libya') ?>&gt; Must See</span></p>
