...
<meta name="description" content="Must see in Tanzania"/>
<meta name="keywords" content="Must see, Tanzania destinations, Travel to Tanzania"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Tanzania</title>
...
Bull Fighting <br>
Game drive at Tarangire National Park <br>
Hot air ballooning <br>
Mount Meru <br>
Mwenge Carvers' Market <br>
National Museum & House of Culture <br>
Ngorongoro crater safari <br>
Ruaha River Gorge <br>
Safari in the Serengeti <br>
Scuba-diving <br>
Selous Game Reserve <br>
Spice plantation tours <br>
Stone Town <br>
Sukuma Museum <br>
Tracking chimpanzees on Lake Tanganyika <br>
Trekking Mount Kilimanjaro <br>
Visit Bagamoyo <br>
Zanzibar's beaches 
</p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/tanzania_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/tanzania', 'Tanzania') ?>&gt; Must See</span></p>
