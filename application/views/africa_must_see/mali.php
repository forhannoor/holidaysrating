...
<meta name="description" content="Must see in Mali"/>
<meta name="keywords" content="Must see, Malidestinations, Travel to Mali"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Mali</title>
...
<div class="edit1"><p>  
Ancient villages <br><br>
Bamako <br><br>
Djenné <br><br>
Gao <br><br>
La Boucle de Baoule National Park <br><br>
Mopti <br><br>
San and Ségou <br><br>
Timbuktu <br><br>
Trek Dogon country </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mali_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mali', 'Mali') ?>&gt; Must See</span></p>
