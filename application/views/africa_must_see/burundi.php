...
<meta name="description" content="Must see in Burundi"/>
<meta name="keywords" content="Must see, Burundi destinations, Travel to Burundi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Burundi</title>
...
<div class="edit1"><p>  Arts and crafts <br>
Bujumbura <br>
Flora and fauna <br>
Gitega <br>
Kirundo <br>
Rutovu monument <br>
Stanley and Livingstone </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/burundi_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/burundi', 'Burundi') ?>&gt; Must See</span></p>
