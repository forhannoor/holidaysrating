...
<meta name="description" content="Must see in Senegal"/>
<meta name="keywords" content="Must see, Senegal destinations, Travel to Senegal"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Senegal</title>
...
<div class="edit1"><p>  
Cap Vert Peninsula <br>
Carabane Island <br>
Casamance <br>
Grande Mosquée <br>
Île de Gorée (Gorée Island) <br>
Institut Fondamental d'Afrique Noire (IFAN) <br>
Kafountine <br>
Kedougou <br>
Lac de Guiers <br>
Lac Rose <br>
N’Gor Island <br>
Palmarin N’Gallou <br>
Parc National Aux Oiseaux Du Djoudj <br>
Parc National de Niokolo-Koba <br>
Petite Côte (Little Coast) <br>
Popenguine <br>
Saly <br>
Siné-Saloum delta <br>
St Louis <br>
Toubab Dialao </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/senegal_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/senegal', 'Senegal') ?>&gt; Must See</span></p>
