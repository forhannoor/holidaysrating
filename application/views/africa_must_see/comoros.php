...
<meta name="description" content="Must see in Comoros"/>
<meta name="keywords" content="Must see, Angola destinations, Travel to Comoros"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Comoros</title>
...
<div class="edit1"><p>  <strong> Itsandra <BR><BR>
Mahore (Mayotte) <BR><BR>
Meet the wildlife <BR><BR>
Mitsamiouli <BR><BR>
Moroni <BR><BR>
Mwali (Mohéli) <BR><BR>
Nzwani (Anjouan) <BR><BR>
</strong>Beaches </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/comoros_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/comoros', 'Comoros') ?>&gt; Must See</span></p>
