...
<meta name="description" content="Must see in Botswana"/>
<meta name="keywords" content="Must see, Botswana destinations, Travel to Botswana"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Botswana</title>
...
<div class="edit1"><p>  Central Kalahari Game Reserve <br>
Chobe National Park <br>
Gaborone Game Reserve <br>
Kgalagadi Transfrontier National Park <br>
Khama Rhino Sanctuary <br>
Makgadikgadi Plains <br>
Moremi Wildlife Reserve <br>
Okavango Delta <br>
Okavango Delta canoe ride <br>
Ride an elephant <br>
Sundowner <br>
Tsodilo Hills <br>
Walking safari </p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/botswana_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/botswana', 'Botswana') ?>&gt; Must See</span></p>
