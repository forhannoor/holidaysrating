...
<meta name="description" content="Must see in Morocco"/>
<meta name="keywords" content="Must see, Morocco destinations, Travel to Morocco"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Morocco</title>
...
<div class="edit1"><p>  Aït Benhaddou <br>
Atlantic Coast <br>
Casablanca <br>
Cascades D’Ouzoud <br>
Chefchaouen <br>
...
Jardin Majorelle <br>
Meknes and Volubilis <br>
Merja Zerga National Park <br>
Rif Mountains <br>
Sahara Desert <br>
Tangier <br>
The Souk, Marrakech <br>
Tinerhir <br>
Todra and Dades Gorges </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/morocco_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/morocco', 'Morocco') ?>&gt; Must See</span></p>
