...
<meta name="description" content="Must see in Guinea"/>
<meta name="keywords" content="Must see, Guinea destinations, Travel to Guinea"/>
...
<div class="edit1"><p>  Conakry <br><br>
Faranah <br><br>
Fouta Djalon <br><br>
Kakimbon Caves <br><br>
Katikan <br><br>
Le Voile de la Mariée <br><br>
Tinkisso River </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/guinea_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/guinea', 'Guinea') ?>&gt; Must See</span></p>
