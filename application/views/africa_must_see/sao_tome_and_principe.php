...
<meta name="description" content="Must see in São Tomé and Príncipe"/>
<meta name="keywords" content="Must see, São Tomé and Príncipe destinations, Travel to São Tomé and Príncipe"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | São Tomé and Príncipe</title>
...
Boca de Inferno <br>
Humpback whales <br>
Ilheu Bom Bom island <br>
Pico de Príncipe <br>
Pico de São Tomé <br>
Santo Antonio <br>
São João dos Angolares <br>
São Tomé <br>
São Tomé's rainforest </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sao_tome_and_principe_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sao_tome_and_principe', 'São Tomé and Príncipe') ?>&gt; Must See</span></p>
