...
<meta name="description" content="Must see in Egypt"/>
<meta name="keywords" content="Must see, Egypt destinations, Travel to Egypt"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Egypt</title>
...
Alexandria <BR><BR>
Aswan <BR><BR>
Camel market (Souq al-Gamaal), Birqash <BR><BR>
City of gold <BR><BR>
Diving in the Red Sea <BR><BR>
Go golfing <BR><BR>
Islamic Cairo <BR><BR>
Khan-el Khalili bazaar <BR><BR>
Luxor temples <BR><BR>
Mount Sinai <BR><BR>
Pyramids of Giza <BR><BR>
River Nile cruise <BR><BR>
Saqqara <BR><BR>
Siwa Oasis <BR><BR>
Snorkelling in Sharm el-Sheik <BR><BR>
Suez Canal <BR><BR>
Valley of the Kings </strong></p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/egypt_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/egypt', 'Egypt') ?>&gt; Must See</span></p>
