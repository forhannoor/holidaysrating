...
<meta name="description" content="Must see in Nigeria"/>
<meta name="keywords" content="Must see, Nigeria destinations, Travel to Nigeria"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Nigeria</title>
...
<div class="edit1"><p>  Benin City <br>
Calabar <br>
Cross River National Park <br>
Emir's Palace, Kano <br>
Gashaka Game Reserve <br>
Gidan Makama Museum <br>
Gurara Falls <br>
Ibadan <br>
Ile-Ife <br>
Jos <br>
National Museum in Lagos <br>
Olumirin Falls <br>
Osogbo <br>
Palace of the Emir of Zazzau <br>
Shere Hills <br>
Yankari National Park </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/nigeria_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/nigeria', 'NIgeria') ?>&gt; Must See</span></p>
