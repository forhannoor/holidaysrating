...
<meta name="description" content="Must see in Sierra Leone"/>
<meta name="keywords" content="Must see, Sierra Leone destinations, Travel to Sierra Leone"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Sierra Leone</title>
...
<div class="edit1"><p>  Bo and surrounding area <br>
Bonthe Island <br>
Gola Forest National Park <br>
Kono Diamond Mining Fields <br>
Moa River and Mina River confluence <br>
Mount Bintumani and the Loma Mountains <br>
Old Fourah Bay College <br>
Rogbonko <br>
Sulima <br>
Tiwai Island Wildlife <br>
Banana Islands <br>
Bunce Island <br>
Freetown <br>
Freetown Peninsula <br>
Outamba-Kilimi National Park <br>
Sakanbiarwa <br>
Tacugama Chimpanzee Sanctuary </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sierra_leone_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sierra_leone', 'Sierra Leone') ?>&gt; Must See</span></p>
