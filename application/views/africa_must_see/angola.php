...
<meta name="description" content="Must see in Angola"/>
<meta name="keywords" content="Must see, Angola destinations, Travel to Angola"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Angola</title>
...
<div class="edit1"><p>Voodoo temples<br>
 roadside fetishes, and  fetish markets <br>
Grande Marche du Dantopka <br>
Ouidah's local museum<br>
Abomey Historical Museum in the royal palace <br>
Ganvie<br>
Grand Popo <br>
Pendjari National Park <br>
W National Park <br>
The unique and eccentric mud and clay tower-houses, known as tata </p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/angola_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/angola', 'Angola') ?>&gt; Must See</span></p>
