...
<meta name="description" content="Must see in South Africa"/>
<meta name="keywords" content="Must see, South Africa destinations, Travel to South Africa"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | South Africa</title>
...
<div class="edit1"><p>  Cape Point <br>
Drive the Garden Route <br>
Robben Island <br>
Addo Elephant National Park <br>
Anglo-Boer War Battlefields <br>
Apartheid Museum <br>
Blyde River Canyon Nature Reserve <br>
Boulders Beach penguins <br>
Climb Table Mountain <br>
Explore the Winelands <br>
Game drives <br>
Hike the Drakensburg mountain trails <br>
Kirstenbosch National Botanical Garden <br>
Play a round of Golf <br>
Scuba diving at Sodwana Bay <br>
Shark-diving <br>
Spring flowers in Namaqualand <br>
Surfing <br>
Township tours <br>
Whale-watching in Hermanus </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/south_africa_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/south_africa', 'South Africa') ?>&gt; Must See</span></p>
