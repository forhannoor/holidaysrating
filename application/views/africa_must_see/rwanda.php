...
<meta name="description" content="Must see in Rwanda"/>
<meta name="keywords" content="Must see, Rwanda destinations, Travel to Rwanda"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Rwanda</title>
...
<div class="edit1"><p>  A'Kagera National Park <br>
Butare <br>
Cards From Africa, Kigali <br>
Chimpanzee and Colobus monkey trek <br>
Dian Fossey’s grave, Volcanoes National Park <br>
Genocide memorial centre, Kigali <br>
Gisenyi <br>
Golden monkey trek, Volcanoes National Park <br>
Gorilla trek <br>
Kibungu (Umutara) <br>
Kibuye <br>
Kigali <br>
Nyungwe Forest canopy walk <br>
Rwanda National Ballet <br>
Virunga Volcanoes </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/rwanda_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/rwanda', 'Rwanda') ?>&gt; Must See</span></p>
