...
<meta name="description" content="Must see in Algeria"/>
<meta name="keywords" content="Must see, Algeria destinations, Travel to Algeria"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Algeria</title>
...
<div class="edit1"><p> Algeria is one of the great tourist spots with so many things to see.<br><br>

Ancient ruins—mainly those from the Phoenician, Roman, and Byzantine eras.<br>
The Mediterranean beaches<br>
Mostaganem <br>
The Tassili du Hoggar <br>
Timgad <br>
Hippone (so called Annaba)<br>
Madaure <br>
Taghaste <br>
The Aurès<br>
Tebessa (antique Theveste) <br>
Algeria's major cities <br>
Cirta, the capital city of the Kingdom of Numidia <br>
Al Qal'a of Beni Hammad, the first capital of the Hammadid empire <br>
Belzma National Park <br>
<a href="http://www.holidaysrating.com/index.php/africa_cities/algiers">Algiers</a><br>
Hammam Guergour <br>
Babors mountains <br>
Kabylie coast <br>
Tlemcen</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/algeria_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/algeria', 'Algeria') ?>&gt; Must See</span></p>
