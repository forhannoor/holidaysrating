...
<meta name="description" content="Must see in Mauritius"/>
<meta name="keywords" content="Must see, Mauritius destinations, Travel to Mauritius"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Mauritius</title>
...
<div class="edit1"><p>  Beautiful beaches <br>
Black River Gorges National Park<br> 
Blue Bay <br>
Casela Bird Park<br> 
Central Market <br>
Chamarel coloured earths<br> 
Climb Le Pouce <br>
Dine in Domaine du Chasseur <br>
Explore the islands by boat <br>
Go diving <br>
Grand Baie <br>
Grand Bassin <br>
...
Le Souffleur <br>
Mahébourg <br>
Mauritius Aquarium <br>
National History Museum <br>
Pamplemousses Gardens <br>
Port Louis <br>
Quad bike <br>
Rodrigues Island <br>
The Crocodile Park </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mauritius_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mauritius', 'Mauritius') ?>&gt; Must See</span></p>
