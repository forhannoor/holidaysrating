...
<meta name="description" content="Must see in Mozambique"/>
<meta name="keywords" content="Must see, Mozambique destinations, Travel to Mozambique"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Mozambique</title>
...
<div class="edit1">
<p>  Bazaruto Archipelago <br>
Beaches <br>
Birdwatching <br>
Game fishing <br>
Go diving and snorkelling <br>
Go on safari <br>
Gorongosa National Park <br>
Hike national parks <br>
Ilha de Moçambique <br>
Inhaca Island <br>
Maputo <br>
Maputo National Reserve <br>
Marromeu National Park <br>
Mozambique's beaches <br>
Pemba <br>
Quirimbas National Park </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mozambique_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/mozambique', 'Mozambique') ?>&gt; Must See</span></p>
