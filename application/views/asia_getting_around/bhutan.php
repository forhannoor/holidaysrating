...
<meta name="description" content="Getting around in Bhutan"/>
<meta name="keywords" content="Getting around in Bhutan, Travel in Bhutan, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Bhutan</title>
...
There are no local airline routes inside Bhutan. <br><br>
Side of road: <br>
 Left<br><br>
Road quality: <br>
Bhutan  has a fairly good internal road network with well over 3,000km (1,800 miles) of surfaced road. <br><br>

The average speed is less than 40kph (25mph). <br>

The main routes run north from Phuentsholing to the western regions of Paro and Thimphu, and west-east, across the Pele La Pass and Thrumshing La Pass to the central valleys and eastern regions. </p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bhutan_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/bhutan', 'Bhutan') ?>&gt; Getting around</span></p>
