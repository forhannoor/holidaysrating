...
<meta name="description" content="Getting around in Cambodia"/>
<meta name="keywords" content="Getting around in Cambodia, Travel in Cambodia, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Cambodia</title>
...
<p>  
Air: <br>
Internal flights run between Phnom Penh and Siem Reap for Angkor. The national airline is Cambodia Angkor Air which commenced operations in July 2009. <br> <br>
Side of road: <br>
 Right <br> <br>
Road quality: <br>
Roads vary from brilliant to very poor. <br> <br>
Car hire: <br>
...
Coach: <br>
Buses are cheaper and faster than trains running the same route. <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cambodia_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/cambodia', 'Cambodia') ?>&gt; Getting around</span></p>
