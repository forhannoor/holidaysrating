...
<meta name="description" content="Getting around in Brunei"/>
<meta name="keywords" content="Getting around in Brunei, Travel in Brunei, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Brunei</title>
...
<p>  
Air Flights: <br>
Brunei does not have any internal flights. <br> <br>
Road: <br>
Brunei offers brilliant paved roads. <br> <br>
Side of road: <br>
 Left <br> <br>
Road quality: <br>
Brunei's road network is great in quality. <br> <br>
Car hire: <br>
Car hiring is possible in the city. Almost all the hotels serve this service to customers. And Brunei serves world’s cheapest patrol. <br> <br>
There are a number of taxi services. Most of the taxi services are officially run but all of them operated by independent drivers. <br> <br>

Coach: <br>
Many bus services are available which link Bandar Seri Begawan's city centre bus terminal with towns such as Kuala Lurah, Muara, Tutong and Seria. <br> <br>

By water: <br>
Water taxis are seen in the Brunei River which link Bandar Seri Begawan's waterfront with the sultanate's most famous water village, Kampung Ayer. 
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/brunei_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/brunei', 'Brunei') ?>&gt; Getting around</span></p>
