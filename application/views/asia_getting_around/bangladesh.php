...
<meta name="description" content="Getting around in Bangladesh"/>
<meta name="keywords" content="Getting around in Bangladesh, Travel in Bangladesh, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Bangladesh</title>
...
<div class="edit1"><p> <strong> Airline: </strong> <br>
A number of airlines services are available. Biman Bangladesh Airlines, United Airlines and Regent Airlines operate both local and international flights. <br><br>
<strong> Car: </strong> <br>
Hiring a car is very easy. Almost all the hotels offer this service. But one can manage it from anywhere in the capital. <br><br>
<strong> Rickshaw: </strong> <br>
This is one of the main attractions in Bangladesh. Rickshaw is the main form of transportation which is pollution and engine free and driven by a person. <br><br>
<strong> Rail: </strong> <br>
Bangladesh is proud of its rail services. All the major cities are connected by railroads. So traveling in Bangladesh is more than easy. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bangladesh_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/bangladesh', 'Bangladesh') ?>&gt; Getting around</span></p>
