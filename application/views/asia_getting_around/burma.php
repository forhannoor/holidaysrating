...
<meta name="description" content="Getting around in Burma (Myanmar)"/>
<meta name="keywords" content="Getting around in Burma, Travel in Myanmar, Transport, Bus, Taxi"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Getting around | Burma (Myanmar)</title>
...
<div class="edit1">
<p>
When you are traveling to Burma you should consider taking some cotton made cloths. The temperature may make you sweat all the time. But the best months to visit are from November to February because the temperature remains in a stable condition. <br> <br>

The national airline is the government joint-venture Myanmar Airways International. Generally the cheapest way to get to Myanmar is either via a Middle Eastern airport, for example with Qatar Airways or via a regional hub such as Singapore or Bangkok. </p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/burma_around', 'Leave a comment') ?>
</div>
...
<div class="top-around"></div>
<div class="middle-around">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/burma', 'Burma') ?>&gt; Getting around</span></p>
