...
<meta name="description" content="Local Food Bhutan"/>
<meta name="keywords" content="Food, What to eat in Bhutan, Travel to Bhutan, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Bhutan</title>
...
<div class="edit1"><p>In Bhutan, people are mostly vegetarian and do not prefer meat. But meat can be found which is imported from India. <br><br>
Popular foods<br><br>
• Datse (cow's milk cheese), sometimes served in a dish with red chillies (ema datse). <br>
• Tshoem (curry), usually served with rice. <br>
• Eue chum (pink rice), a nutty-flavoured variety unique to Bhutan. <br><br>
Drinks: <br><br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bhutan_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/bhutan', 'Bhutan') ?>&gt; Local Food</span></p>
