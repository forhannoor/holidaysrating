...
<meta name="description" content="Local Food Cambodia"/>
<meta name="keywords" content="Food, What to eat in Cambodia, Travel to Cambodia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Cambodia</title>
...
<div class="edit1">Popular foods:<br><br>
• Balut <br>
• Prahok <br>
• Crispy fried spiders <br>
• Amok trey <br>
• Kuy teav <br>
• Bai cha <br>
• Kralan <br>
...
• Pleah sach ko <br><br>
Drinks: <br><br>
• Fresh coconut juice. <br>
• Green tea. <br>
• Rice wine. <br>
• Khmer drink (soda water with a squeeze of lemon) <br> 
• Angkor beer. <br>
• Cambodia beer <p></p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cambodia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/cambodia', 'Cambodia') ?>&gt; Local Food</span></p>
