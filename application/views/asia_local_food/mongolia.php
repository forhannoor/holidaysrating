...
<meta name="description" content="Local Food Mongolia"/>
<meta name="keywords" content="Food, What to eat in Mongolia, Travel to Mongolia, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Mongolia</title>
...
<div class="edit1"><p><strong> Most popular foods: </strong> <br><br>
• Pulao (a kind of rice with chicken or beef) <br>
• Qabli pulao (A popular variant of pulao served with lamb, sometimes mistakenly called Kabuli pulao). <br>
• Shorma (soup). <br>
• Afghanis eat plenty of seasonal fruit, <br><br>
<strong> National drinks: </strong> <br><br>
•  is tea (chai). <br>
• Dugh (yoghurt flavoured with rose water and salt). </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/mongolia_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/mongolia', 'Mongolia') ?>&gt; Local Food</span></p>
