...
<meta name="description" content="Local Food Bangladesh"/>
<meta name="keywords" content="Food, What to eat in Bangladesh, Travel to Bangladesh, Local Food, Recipes"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Local Food | Bangladesh</title>
...
<div class="edit1"><p>
Bangladesh has a rich history on food, eating and drinking. The ancient rulers had introduced many recipes which has been cooked all through the country. <br> <br>

<strong> Popular foods: </strong> <br>
Biriani (fried rice with beef) <br>
Polau <br>
Shingara/Shomucha (a crispy snakes item) <br>
Tandury Chicken <br>
Bhuna Khuchudi ( hotchpotch ) <br>
Parat (bread-like food, great for breakfast) <br>
Grilled-chicken <br>
Bhaat (plain rice) <br>
Fish (Hilsa, Rohu, Climbing perch and shrimp are great in Bangladesh) <br> <br>

<strong> Drinks:</strong> <br> <br>
Borhani <br>
Tea <br>
Sarbat (lemon water, juice or anything) <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bangladesh_food', 'Leave a comment') ?>
</div>
...
<div class="top-food"></div>
<div class="middle-food">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/bangladesh', 'Bangladesh') ?>&gt; Local Food</span></p>
