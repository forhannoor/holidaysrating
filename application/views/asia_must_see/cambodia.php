...
<meta name="description" content="Must see in Cambodia"/>
<meta name="keywords" content="Must see, Cambodia destinations, Travel to Cambodia"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Cambodia</title>
...
Angkor<br>
Bayon<br>
Bokor Hill Station<br>
Cycling around Angkor<br>
Dolphin spotting<br>
Feast on fresh seafood<br>
Fire a rocket-launcher<br>
Kampot<br>
National Museum<br>
Phnom Tamao Wildlife Sanctuary<br>
Revisit history<br>
Royal Palace<br>
Shop for silver<br>
Sihanoukville<br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cambodia_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/cambodia', 'Cambodia') ?>&gt; Must See</span></p>
