...
<meta name="description" content="Must see in Afghanistan"/>
<meta name="keywords" content="Must see, Afghanistan destinations, Travel to Afghanistan"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Must see | Afghanistan</title>
...
Valley of Paghman<br>

Visit Ka Faroshi bird market<br>

Walk on Bibi Mahru Hill<br>

Wander Babur's Gardens (Bagh-e Babur) </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/afghanistan_must_see', 'Leave a comment') ?>
</div>
...
<div class="top-must-see"></div>
<div class="middle-must-see">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/afghansiatn', 'Afghanistan') ?>&gt; Must See</span></p>
