...
<area shape="poly" coords="191, 151, 186, 141, 196, 136, 202, 138, 215, 132, 249, 140, 262, 144, 281, 144, 276, 138, 285, 129, 331, 126, 337, 132, 352, 134, 363, 130, 385, 146, 405, 146, 418, 152, 418, 161, 408, 162, 401, 169, 389, 170, 388, 181, 376, 179, 366, 179, 355, 181, 343, 178, 329, 179, 321, 180, 304, 187, 293, 185, 288, 175, 278, 174, 265, 173, 257, 167, 261, 161, 252, 159, 243, 161, 225, 162, 213, 176, 192, 163, 200, 159, 212, 162, 214, 155, 203, 149" href="<?php echo base_url() ?>index.php/asia_countries/kazakhstan" alt="Kazakhstan" title="Kazakhstan"   />
<area shape="poly" coords="295, 194, 309, 190, 316, 195, 341, 198, 346, 205, 326, 207, 326, 200, 308, 202, 299, 203" href="<?php echo base_url() ?>index.php/asia_countries/tajikistan" alt="Tajikistan" title="Tajikistan"   />
<area shape="poly" coords="206, 178, 219, 181, 234, 178, 245, 180, 259, 189, 278, 200, 272, 204, 266, 209, 256, 208, 245, 208, 236, 198, 220, 194, 204, 194, 194, 196, 198, 185, 197, 180" href="<?php echo base_url() ?>index.php/asia_countries/turkmenistan" alt="Turkmenistan" title="Turkmenistan"   />
<area shape="poly" coords="322, 183, 330, 180, 338, 182, 373, 180, 383, 184, 365, 188, 352, 191, 344, 193, 342, 197, 328, 193, 334, 188" href="<?php echo base_url() ?>index.php/asia_countries/kyrgyzstan" alt="Kyrgyzstan" title="Kyrgyzstan"   />
<area shape="poly" coords="711, 118, 719, 129, 713, 133, 724, 143, 703, 153, 696, 165, 680, 171, 680, 163, 671, 162, 660, 174, 653, 176, 664, 181, 674, 185, 682, 180, 688, 182, 683, 191, 715, 215, 705, 242, 648, 263, 651, 272, 638, 279, 637, 275, 640, 264, 616, 264, 603, 260, 571, 266, 564, 271, 551, 264, 540, 261, 542, 252, 537, 242, 528, 243, 518, 238, 502, 239, 487, 248, 480, 246, 464, 246, 440, 250, 407, 241, 380, 236, 376, 230, 380, 225, 367, 212, 347, 205, 349, 200, 346, 192, 362, 192, 392, 183, 392, 171, 404, 169, 407, 164, 422, 162, 421, 155, 434, 150, 442, 157, 451, 157, 457, 169, 486, 173, 499, 179, 516, 174, 554, 180, 587, 173, 601, 164, 622, 151, 634, 140, 626, 136, 612, 139, 609, 132, 615, 127, 616, 114, 634, 111, 668, 121, 687, 122, 697, 126"  href="<?php echo base_url() ?>index.php/asia_countries/china" alt="China" title="China"   />
<area shape="poly" coords="463, 252, 468, 249, 482, 249, 487, 252, 471, 254" href="<?php echo base_url() ?>index.php/asia_countries/bhutan" alt="Bhutan" title="Bhuntan"   />
<area shape="poly" coords="724, 144, 724, 152, 717, 162, 726, 165, 721, 169, 710, 170, 710, 165, 700, 164, 705, 155, 710, 155" href="<?php echo base_url() ?>index.php/asia_countries/north_korea" alt="North Korea" title="North Korea"   />
<area shape="poly" coords="732, 166, 723, 169, 732, 183, 747, 177" href="<?php echo base_url() ?>index.php/asia_countries/south_korea" alt="South korea" title="South Korea"   />
<area shape="poly" coords="776, 116, 799, 115, 807, 118, 805, 127, 825, 156, 799, 174, 784, 180, 782, 194, 762, 184, 772, 169, 792, 163, 792, 153, 800, 155, 802, 148, 795, 137, 781, 131" href="<?php echo base_url() ?>index.php/asia_countries/japan" alt="Japan" title="Japan"   />
<area shape="poly" coords="721, 241, 726, 233, 732, 233, 731, 247" href="<?php echo base_url() ?>index.php/asia_countries/taiwan" alt="Taiwan" title="Taiwan"   />
<area shape="poly" coords="134, 179, 142, 186, 152, 183, 170, 196, 182, 200, 198, 197, 221, 196, 246, 208, 233, 226, 237, 231, 234, 238, 249, 251, 235, 250, 228, 256, 197, 252, 193, 244, 184, 245, 175, 245, 160, 238, 153, 237, 147, 226, 138, 223, 132, 221, 132, 211, 125, 204, 131, 197, 130, 190" href="<?php echo base_url() ?>index.php/asia_countries/iran" alt="Iran" title="Iran"   />
<area shape="poly" coords="131, 178, 122, 166, 102, 167, 75, 156, 52, 156, 39, 153, 27, 154, 17, 153, 8, 166, 17, 171, 29, 170, 38, 179, 54, 176, 83, 183, 95, 184, 103, 187, 115, 187, 125, 188" href="<?php echo base_url() ?>index.php/asia_countries/turkey" alt="Turkey" title="Turkey"   />
<area shape="poly" coords="126, 161, 135, 165, 146, 167, 156, 173, 166, 172, 171, 180, 160, 187, 154, 182, 144, 182, 129, 170" href="<?php echo base_url() ?>index.php/regions/europe" alt="Europe" title="Europe"   />
<area shape="poly" coords="43, 56, 63, 49, 106, 51, 178, 40, 206, 39, 222, 38, 202, 50, 186, 61, 176, 67, 168, 73, 150, 74, 132, 82, 120, 94, 123, 108, 139, 131, 120, 137, 99, 138, 97, 144, 83, 145, 82, 134, 65, 134, 41, 143, 37, 151, 0, 144, 0, 77, 15, 76" href="<?php echo base_url() ?>index.php/regions/europe" alt="Europe" title="Europe"   />
<area shape="poly" coords="625, 267, 613, 277, 638, 291, 650, 309, 614, 329, 613, 322, 634, 307, 628, 292, 620, 289, 598, 279, 596, 274, 588, 274, 580, 268, 600, 262" href="<?php echo base_url() ?>index.php/asia_countries/vietnam" alt="Vietnam" title="Vietnam"   />
<area shape="poly" coords="576, 268, 587, 276, 593, 277, 593, 280, 623, 291, 627, 301, 621, 301, 612, 303, 612, 295, 604, 290, 594, 285, 587, 287, 579, 287, 573, 289, 570, 283, 563, 276" href="<?php echo base_url() ?>index.php/asia_countries/laos" alt="Laos" title="Laos"   />
<area shape="poly" coords="739, 265, 750, 265, 756, 272, 753, 279, 763, 284, 777, 279, 791, 286, 803, 301, 807, 311, 797, 318, 786, 318, 779, 314, 756, 332, 748, 325, 767, 305, 760, 299, 732, 320, 721, 312, 745, 293, 735, 279" href="<?php echo base_url() ?>index.php/asia_countries/philippines" alt="Philippines" title="Philippines"   />
<area shape="poly" coords="23, 200, 22, 217, 11, 208, 14, 237, 21, 245, 18, 258, 26, 267, 30, 279, 43, 284, 55, 299, 69, 310, 125, 310, 115, 325, 87, 345, 64, 350, 34, 361, 11, 379, 24, 404, 0, 404, 0, 194, 6, 192" href="<?php echo base_url() ?>index.php/regions/africa" alt="Africa" title="Africa"   />
<area shape="poly" coords="46, 193, 52, 189, 57, 191, 50, 198" href="<?php echo base_url() ?>index.php/asia_countries/lebanon" alt="lebanon" title="lebanon"   />
<area shape="poly" coords="43, 194, 46, 198, 29, 210, 29, 200" href="<?php echo base_url() ?>index.php/asia_countries/israel" alt="Israel" title="Israel"   />
<area shape="poly" coords="59, 187, 62, 180, 83, 186, 106, 186, 98, 190, 94, 196, 65, 198, 54, 197, 63, 192" href="<?php echo base_url() ?>index.php/asia_countries/syria" alt="Syria" title="Syria"   />
<area shape="poly" coords="48, 201, 45, 203, 31, 210, 36, 216, 54, 209, 53, 205, 63, 204, 64, 199, 53, 199" href="<?php echo base_url() ?>index.php/asia_countries/jordan" alt="Jordan" title="Jordan"   />
<area shape="poly" coords="116, 188, 128, 196, 120, 204, 131, 215, 128, 221, 122, 221, 117, 225, 101, 223, 91, 214, 80, 208, 69, 205, 67, 199, 91, 198, 100, 191" href="<?php echo base_url() ?>index.php/asia_countries/iraq" alt="Iraq" title="Iraq"   />
<area shape="poly" coords="130, 225, 131, 234, 122, 227, 125, 223" href="<?php echo base_url() ?>index.php/asia_countries/kuwait" alt="Kuwait" title="Kuwait"   />
<area shape="poly" coords="146, 244, 138, 247, 146, 256" href="<?php echo base_url() ?>index.php/asia_countries/qatar" alt="Qatar" title="Qatar"   />
<area shape="poly" coords="52, 206, 65, 206, 74, 207, 87, 214, 96, 224, 119, 228, 135, 242, 142, 257, 181, 268, 171, 275, 110, 276, 94, 282, 83, 279, 71, 277, 60, 281, 60, 275, 52, 270, 48, 259, 39, 255, 39, 242, 34, 236, 29, 235, 29, 228, 22, 213, 27, 210, 37, 215, 44, 210" href="<?php echo base_url() ?>index.php/asia_countries/saudi_arabia" alt="Saudi Arabia" title="Saudi Arabia"   />
...
<area shape="poly" coords="539, 284, 540, 291, 550, 299, 547, 303, 559, 316, 554, 324, 552, 313, 542, 304, 534, 296, 513, 303, 508, 286, 497, 281, 505, 265, 509, 256, 534, 244, 542, 249, 539, 261, 557, 274" href="<?php echo base_url() ?>index.php/asia_countries/myanmar" alt="Myanmar (Burma)" title="Myanmar (Burma)"   />
...
<p style="font-size:10.5px;margin-left:200px">Click on the map for more info about the country or <a href="https://www.google.com.au/maps/@38.0542561,104.6880829,3z" target="_blank">click here</a> for detailed map.</p>
</map>
</div>
...
<div class="intro">
<div class="edit10">
<p><strong>Asia</strong> offers more variety than any other continent. It stretches from the Mediterranean to the monsterous <a href="http://www.holidaysrating.com/index.php/regions/russia">Russia</a>, from the exotic cultures in the <a href="http://www.holidaysrating/index.php/regions/middle_east">Middle East</a> to the breathtaking mysteries of <a href="http://www.holidaysrating.com/index.php/asia_countries/china">China</a>.<br /><br />
...
<p>The continent has got a total size of 31,915,446 square kilometers. Asia is home to hundreds of different cultures and languages. Some of these languages are Russian, Arabic, Mandarin, Cantones, Hindi, Turkish, Korean and Thai.</p>
</div>
...
<p style="margin-bottom:20px;text-align:center">Click on the map or choose a country below:</p>
	...
	<table style="width: 100%">
		...
		<tr>
			<td><?php echo anchor('asia_countries/bahrain', 'Bahrain') ?></td>
		...
		<tr>
			...
			<td><?php echo anchor('asia_countries/myanmar', 'Myanmar (Burma)') ?></td>
...
<iframe width="180" height="110" src="http://www.youtube-nocookie.com/embed/tPRcRnTVuZk" frameborder="0" allowfullscreen></iframe>
<img src="<?php echo base_url() ?>assets/images/border.png" alt="border" />
<h2>Facts</h2>
<ol>
<li>Asia is the largest continent by landmass and human population. The area of Asia is larger than the land area of the moon.</li>
<li>Nine of the 14 tallest mountains in the world can be reached via <?php echo anchor('asia_countries/nepal', 'Nepal') ?>.</li>
<li><?php echo anchor('regions/russia', 'Russia') ?> spans 11 time zones.</li>
<li>In <?php echo anchor('asia_countries/india', 'India') ?> lives more people than in <?php echo anchor('regions/north_america', 'North America') ?>, <?php echo anchor('regions/central_america', 'Central America') ?> and 
<?php echo anchor('regions/south_america', 'South America') ?> - Altogether!</li>
</ol>
...
<li><?php echo anchor('china_provinces/hong_kong ', 'Hong Kong ') ?> <?php echo anchor('asia_countries/china', '(China)') ?></li>
</ul>
</div>
...
<li class="active"><?php echo anchor('regions/asia', 'ASIA') ?></li>
