...
<meta name="description" content="São Tomé, São Tomé and Príncipe"/>
<meta name="keywords" content="São Tomé, Sao Tome"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/sandlogo.jpg" property="og:image" />

<title>São Tomé | São Tomé and Príncipe</title>
...
<h1>WEATHER</h1>
<!--Weather -->
<div class="weather"><script src="http://www.weatherforecastmap.com/weather1.php?zona=sao-tome-and-principe_sao-tome"></script>
<a title="Weather Today in São Tomé" target="blank"  style="margin-left:30px;font-size:9px;font-family:Verdana, Geneva, Tahoma, sans-serif;font-style:italic;color:#C0C0C0" href="http://www.weatherforecastmap.com/sao_tome_and_principe/sao_tome" >Weather Today in São Tomé</a></div>
<!--end of code-->
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sao_tome', 'Leave a comment') ?>
</div>
...
<div class="top"></div>
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt;<?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sao_tome_and_principe', 'São Tomé and Príncipe') ?>&gt; São Tomé</span></p>
<div class="rating">
<div class="score"><p><?php echo round($rating, 1) ?></p></div>
<?php echo anchor('user/rate/sao_tome', img('assets/assets/rate-now.png')); ?>
<br />
