...
<meta name="description" content="Marrakech, Morocco"/>
...
<title>Casablanca | Marrekech</title>
...
<h1>WEATHER</h1>
<!--Weather -->
<div class="weather"><script src="http://www.weatherforecastmap.com/weather1.php?zona=morocco_marrakesh"></script>
<a title="Weather Today in Marrakech" target="blank"  style="margin-left:30px;font-size:9px;font-family:Verdana, Geneva, Tahoma, sans-serif;font-style:italic;color:#C0C0C0" href="http://www.weatherforecastmap.com/morocco/marrakesh" >Weather Today in Marrakech</a></div>
<!--end of code-->
...
<div class="top"></div>
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt;<?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/morocco', 'Morocco') ?>&gt; Marrakech</span></p>
<div class="rating">
<div class="score"><p><?php echo round($rating, 1) ?></p></div>
<?php echo anchor('user/rate/marrakech', img('assets/assets/rate-now.png')); ?>
<br />
