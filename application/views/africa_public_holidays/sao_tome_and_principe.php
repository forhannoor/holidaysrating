...
<meta name="description" content="Public holidays of São Tomé and Príncipe"/>
<meta name="keywords" content="Public holidays, São Tomé and Príncipe holidays, When is perfect time to travel to São Tomé and Príncipe"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Public holidays | São Tomé and Príncipe</title>
...
<div class="edit1"><p>  January 1-New Year's Day <br>	
February 3-Martyrs' Day <br>	
May 1-Labour Day <br>	
July 12-Independence Day <br>	
September 6-Armed Forces Day 	<br>
September 30-Agricultural Reform Day <br>	
November 1-All Saints Day 	<br>
December 21-São Tomé Day <br>	
December 25-Christmas Day</p>  </div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/sao_tome_and_principe_holidays', 'Leave a comment') ?>
</div>
...
<div class="top-holidays"></div>
<div class="middle-holidays">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/sao_tome_and_principe', 'São Tomé and Príncipe') ?>&gt; Public holidays</span></p>
