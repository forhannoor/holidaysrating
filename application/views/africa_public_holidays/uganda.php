...
<meta name="description" content="Public holidays of Uganda"/>
<meta name="keywords" content="Public holidays, Uganda holidays, When is perfect time to travel to Uganda"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Public holidays | Uganda</title>
...
•	January 26: Liberation Day<br>
•	March 8: International Women's Day<br>
•	April 18: Good Friday<br>
•	April 21: Easter Monday<br>
•	May 1: Labour Day<br>
•	June 3: Martyr's Day<br>
•	June 9: National Heroes Day<br>
•	Date variable: Eid al-Fitr (End of Ramadan) <br>
•	October 9: Independence Day<br>
•	Date variable: Eid al-Adha (Feast of the Sacrifice) <br>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/uganda_holidays', 'Leave a comment') ?>
</div>
...
<div class="top-holidays"></div>
<div class="middle-holidays">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/uganda', 'Uganda') ?>&gt; Public holidays</span></p>
