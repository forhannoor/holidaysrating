...
<meta name="description" content="Before you go to Bhutan"/>
<meta name="keywords" content="Before you go to Bhutan, Travel to Bhutan, Planning your holiday to Bhutan"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Before you go | Bhutan</title>
...
<div class="edit1">
<p> Airlines and Geographical Information <br> <br>
To travel Bhutan, you must have a good map of the country. You need to know about the airlines as well. Druk Air is the national airline of Bhutan. Druk Air operates from a Bangladesh, India, Kathmandu (Nepal) and Bangkok. Druk air may not give any ticket before visa clearance. <br> <br>
Traveling to Bhutal by rail is possible from Siliguri (India). <br> <br>

Bhutan has got monsoon climate, so cotton cloth should be considered while packing. Some emergency equipment and medicine are good to carry with. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bhutan_before_you_go', 'Leave a comment') ?>
</div>
...
<div class="top-before"></div>
<div class="middle-before">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/bhutan', 'Bhutan') ?>&gt; Before you go</span></p>
