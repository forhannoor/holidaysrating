...
<meta name="description" content="Before you go to Cambodia"/>
<meta name="keywords" content="Before you go to Cambodia, Travel to Cambodia, Planning your holiday to Cambodia"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Before you go | Cambodia</title>
...
<div class="edit1"><p> <strong>Airlines:</strong> <br>
You must decide the convenient airline for your travel.<br><br> You will find  Cambodia Angkor Air which is the national airline and operates flights from  Thailand, Singapore and China, to Vientiane. Most long-haul flights to Cambodia need a stop-over in Bangkok, Hong Kong or Singapore first.  You will also find some cheap airlines such as Jet Star and Tiger Airways which fly daily to Cambodia. <br> <br>

<strong>Driving to Cambodia</strong> <br> 
Driving to Cambodia is not very common. If you want to drive to Cambodia then drive from Phnom Penh to Ho Chi Minh City in a day but you have to show documents and face formalities regarding the use of the same vehicle all the way. <br> <br>
You must have Vietnamese visas in advance but Cambodian visas can be obtained at the border. <br> <br>
<strong>Clothing</strong> <br>
Bhutan has got monsoon climate, so cotton-made clothes should be considered while packing. Some emergency equipment and medicine are good to carry with. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/cambodia_before_you_go', 'Leave a comment') ?>
</div>
...
<div class="top-before"></div>
<div class="middle-before">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/cambodia', 'Cambodia') ?>&gt; Before you go</span></p>
