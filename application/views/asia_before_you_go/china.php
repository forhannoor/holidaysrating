...
<meta name="description" content="Before you go to China"/>
<meta name="keywords" content="Before you go to China, Travel to China, Planning your holiday to China"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Before you go | China</title>
...
<div class="edit1"><p>
Tourist can find Air China (CA) for going to China. Autumn, when tourist numbers are down but the weather in many regions remains pleasant, is a good time to find flights. Fares can be higher in and around peak holiday seasons such as Chinese New Year. <br> <br>
Early autumn around September and October, when temperatures are pleasant and rainfall is low, is generally seen as an optimum time to visit. Spring is also popular, for similar reasons, and the many tourists visit in March or April. <br> <br>
Essential clothing: <br> <br>
If you are travelling in winter then heavyweight clothing must be carried. Sometimes boots are suggested to cope with what can be acute cold. But cotton-made cloths could be good if you are in summer time. 
</p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/china_before_you_go', 'Leave a comment') ?>
</div>
...
<div class="top-before"></div>
<div class="middle-before">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/china', 'China') ?>&gt; Before you go</span></p>
