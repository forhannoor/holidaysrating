...
<meta name="description" content="Public holidays of Indonesia"/>
<meta name="keywords" content="Public holidays, Indonesia holidays, When is perfect time to travel to Indonesia"/>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/indonesia_holidays', 'Leave a comment') ?>
</div>
...
<div class="top-holidays"></div>
<div class="middle-holidays">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/indonesia', 'Indonesia') ?>&gt; Public holidays</span></p>
