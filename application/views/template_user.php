...
<p class="sidebar-item"><?php echo img('assets/assets/camera.png') ?> <?php echo anchor('user/upload_image', 'Upload Photo') ?></p>
<p class="sidebar-item"><?php echo img('assets/assets/video.png') ?> <?php echo anchor('topmenu/dump_video', 'Upload Video') ?></p>
<p class="sidebar-item"><?php echo img('assets/assets/settings.png') ?> <?php echo anchor('user/settings', 'Profile Settings') ?></p>
<p class="sidebar-item"><?php echo img('assets/assets/power.png') ?> <?php echo anchor('auth/logout', 'Log Out') ?></p>
<br />
