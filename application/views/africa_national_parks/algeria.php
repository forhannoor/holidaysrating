...
<meta name="description" content="National Parks Algeria"/>
<meta name="keywords" content="National Parks Algeria, World Heritage"/>
...
<ul>
<li><strong>Belezma National Park</strong><br />
Text is coming soon</li>

<li><strong>Chréa National Park</strong><br />
Text is coming soon</li>

<li><strong>Djurdjura National Park</strong><br />
Text is coming soon</li>

<li><strong>El Kala National Park</strong><br />
Text is coming soon</li>

<li><strong>Gouraya National Park</strong><br />
Text is coming soon</li>

<li><strong>Tassili n'Ajjer</strong><br />
Text is coming soon</li>

<li><strong>Taza National Park</strong><br />
Text is coming soon</li>

<li><strong>Théniet El Had National Park</strong><br />
Text is coming soon</li>

<li><strong>Tlemcen National Park</strong><br />
Text is coming soon</li>
...
<br />
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/algeria_parks', 'Leave a comment') ?>
</div>
...
<div class="top-park"></div>
<div class="middle-park">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/africa', 'Africa') ?>&gt; <?php echo anchor('africa_countries/algeria', 'Algeria') ?>&gt; National Parks</span></p>
