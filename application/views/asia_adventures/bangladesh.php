...
<meta name="description" content="Adventures Bangladesh"/>
<meta name="keywords" content="Adventures Bangladesh, Travel to Bangladesh, Must do"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Adventures | Bangladesh</title>
...
<div class="edit1"><p> Bangladesh is a country with so many natural wonders. But if you want to get the real kind of adventure then you must visit Sundarbans and also Bandarban. Sundarbans is one of the largest mangrove forests in the world which was declared as world heritage site by UNESCO. Sundarbans contains so many kinds of wild animals and the king of tigers, the Royel Bengal Tiger. Royel Bengal Tiger is only found in Sundarbans and nowhere else in the world. Travelers have to go in the forest though ship so the journey will be thrilling and adventourous. <br><br>
Bandarban is also a great place which is regarded as one of the most gorgeous travel destinations in Bangladesh. It is a part of Chittagong Hill Tracts. The hilly region will be adventurous as well as thrilling for the young travelers. </p>
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bangladesh_adventures', 'Leave a comment') ?>
</div>
...
<div class="top-adventures"></div>
<div class="middle-adventures">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/bangladesh', 'Bangladesh') ?>&gt; Adventures</span></p>
