...
<meta name="description" content="Adventures Japan"/>
<meta name="keywords" content="Adventures Japan, Travel to Japan, Must do"/>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/japan_adventures', 'Leave a comment') ?>
</div>
...
<div class="top-adventures"></div>
<div class="middle-adventures">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/japan', 'Japan') ?>&gt; Adventures</span></p>
