...
<meta name="description" content="Adventures Bhutan"/>
<meta name="keywords" content="Adventures Bhutan, Travel to Bhutan, Must do"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Adventures | Bhutan</title>
...
<div class="edit1"><p> Bhutan has got both cultural and natural beauty. People get mesmerized by its wonderful natural landscapes, colorful people and hills. Adventure can also be possible by a number of ways. <br> <br>
Trekking <br>
Go for trekking around the valleys as well as the mountain gorges. You will see the panorama is simply magnificent. The high altitude Snowman Trek (25 days) is arduous but in Bumthang, travellers can join four to seven day cultural tours through the villages. You might consider mountain bike along the Paro Valley for a thrilling experience. Sometimes bicycles can be found in Thimpu and trails are suitable for a range of abilities. </p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/bhutan_adventures', 'Leave a comment') ?>
</div>
...
<div class="top-adventures"></div>
<div class="middle-adventures">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/bhutan', 'Bhutan') ?>&gt; Adventures</span></p>
