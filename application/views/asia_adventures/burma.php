...
<meta name="description" content="Adventures Burma (Myanmar)"/>
<meta name="keywords" content="Adventures Burma, Travel to Myanmar, Must do"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>

<title>Adventures | Burma (Myanmar)</title>
...
<div class="edit1"><p>  Flight times: <br>
From Yangon to Mandalay or Nyaung U (for Bagan) takes 55 minutes; to Heho is 1 hour 10 minutes. <br> <br>
Road: <br>
With trains time-consuming and untrustworthy, road travel could be the best way to get around if you are on a budget <br> <br>

Side of road: <br>
 Right <br> <br>
Road quality: <br>
Some road get damaged every year because of continuous monsoon rain. <br> <br>

Car hire: <br>
Car is available for hire. Most of the hotels and rest houses offer car services. But before hiring a car you make sure you know the price and taxes to avoid trouble. Sometimes bargaining might work. <br> <br>
Taxi: <br>
Taxis are available everywhere in the city. It is the best kind of transport for you which will let you see all the places and do some shopping. <br> <br>
Coach: <br>
Buses are cheaper and faster than trains running the same route. 
</p>  
</div>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/burma_adventures', 'Leave a comment') ?>
</div>
...
<div class="top-adventures"></div>
<div class="middle-adventures">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt; <?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/burma', 'Burma') ?>&gt; Adventures</span></p>
