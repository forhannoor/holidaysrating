...
<meta name="description" content="Quanzhou, China"/>
<meta name="keywords" content="Quanzhou"/>
<meta name="author" content="Raymond"/>
<meta name="robots" content="index, follow"/>
<meta name="revisit-after" content="1 days"/>
<meta content="<?php echo base_url() ?>assets/images/sandlogo.jpg" property="og:image" />

<title>Quanzhou | China</title>
...
<h1>WEATHER</h1>
<!--Weather -->
<div class="weather"><script src="http://www.weatherforecastmap.com/weather1.php?zona=china_quanzhou"></script>
<a title="Weather Today in Quanzhou" target="blank"  style="margin-left:30px;font-size:9px;font-family:Verdana, Geneva, Tahoma, sans-serif;font-style:italic;color:#C0C0C0" href="http://www.weatherforecastmap.com/china/quanzhou" >Weather Today in Quanzhou</a></div>
<!--end of code-->
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/quanzhou', 'Leave a comment') ?>
</div>
...
<div class="top"></div>
<div class="middle">
<p><span>You are here&gt; <?php echo anchor('home/index', 'Home') ?>&gt;<?php echo anchor('topmenu/worldmap', 'Worldmap') ?>&gt;<?php echo anchor('regions/asia', 'Asia') ?>&gt; <?php echo anchor('asia_countries/china', 'China') ?>&gt; Quanzhou</span></p>

<div class="rating">
<div class="score"><p><?php echo round($rating, 1) ?></p></div>
<?php echo anchor('user/rate/quanzhou', img('assets/assets/rate-now.png')); ?>
<br />
