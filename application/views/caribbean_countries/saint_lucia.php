...
<meta content="<?php echo base_url() ?>assets/images/flags/caribbean/saint-lucia.gif" property="og:image" />

<title>Saint Lucia | Caribbean</title>
...
<?php  endif?>
<h1>Introduction</h1>
<div class="flag" style="float:left"><img src="<?php echo base_url() ?>assets/images/flags/caribbean/saint-lucia.jpg" alt="Saint Lucia" />
<p style="float:right;width:75%"><strong>Saint Lucia</strong> is an island in the Lesser Antilles in the North-Eastern part of the Caribbean. It has a size of 617 square kilometres.</p>
<br />
...
<p>Saint Lucia has got one National Park; Pigeon Island National Park.</p>
...
<div class="clear"></div>
<div class="comment">
<img src="<?php echo base_url() ?>assets/images/comments.png" alt="comment" style="margin-left:300px" /><?php echo anchor('user/make_comment/saint_lucia', 'Leave a comment') ?>
</div>
